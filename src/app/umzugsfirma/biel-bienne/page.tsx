...
const combinedSchema = {
  ...
  "@graph": [
    ...
    { "@type": "BreadcrumbList", "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "Biel/Bienne", "item": `https://online-offerten.ch${canonicalUrl}` }
    ]},
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://online-offerten.ch/umzugsfirma/biel-bienne', siteName: 'Online-Offerten.ch',
