...
import { ArrowRight, CheckCircle, ShieldCheck, TrendingUp, Calculator, FileText, Mail, BarChart3, MapPin, Building, Star, ChevronRight, Home } from 'lucide-react'
import ZurichSidebar from '@/src/components/locations/ZurichSidebar'
            ...
            <div className="grid md:grid-cols-5 gap-12 items-center">
              <div className="md:col-span-3">
                ...
                <p className="hero-description text-base sm:text-lg text-gray-600 mb-6 leading-relaxed max-w-2xl">
                  Finden Sie über Online-Offerten.ch die passende Umzugsfirma in Zürich. Vergleichen Sie kostenlos bis zu 5 Offerten von geprüften Umzugsunternehmen im Kanton Zürich – ob Privatumzug, Geschäftsumzug oder Spezialtransport.
                </p>
