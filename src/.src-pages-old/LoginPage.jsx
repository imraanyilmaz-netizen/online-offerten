...
const LoginPage = () => {
  ...
  const metaTitle = "Anmeldung - Partner & Admin Login | Online-Offerten.ch";
  const metaDescription = "Melden Sie sich als Partner oder Administrator bei Online-Offerten.ch an, um Ihr Dashboard zu nutzen und Ihre Anfragen zu verwalten.";
