...
const GrundreinigungPage = () => {
  ...
  const metaKeywords = "grundreinigung schweiz, tiefenreinigung, grundreinigung preise, intensive reinigung, reinigungsfirma grundreinigung, grundreinigung zürich, grundreinigung bern, grundreinigung basel";
  const canonicalUrl = "https://online-offerten.ch/grundreinigung";
  ...
  const schema = useMemo(() => ({
    ...
    "name": "Tiefenreinigung und Grundreinigung",
    ...
    "hasOfferCatalog": {
      "@type": "OfferCatalog",
      "name": "Grundreinigungsdienstleistungen",
      "itemListElement": [
        {
          "@type": "Offer",
          "itemOffered": {
            "@type": "Service",
            "name": "Tiefenreinigung von Wohnungen"
          }
        },
        {
          "@type": "Offer",
          "itemOffered": {
            "@type": "Service",
            "name": "Grundreinigung bei Einzug"
          }
        },
        {
          "@type": "Offer",
          "itemOffered": {
            "@type": "Service",
            "name": "Grundreinigung bei Auszug"
          }
        },
        {
          "@type": "Offer",
          "itemOffered": {
            "@type": "Service",
            "name": "Grundreinigung nach Renovation"
          }
        }
      ]
    },
  ...
  const howToSchema = {
    "@context": "https://schema.org",
    "@type": "HowTo",
    "name": "Ablauf unserer Grundreinigung – Schritt für Schritt",
    "description": "So funktioniert eine professionelle Grundreinigung",
    "step": [
      {
        "@type": "HowToStep",
        "name": "Besichtigung und Offerte",
        "text": "Wir besichtigen Ihre Wohnung, beurteilen den Zustand und erstellen eine genaue Offerte."
      },
      {
        "@type": "HowToStep",
      ...
      },
      {
        ...
        "text": "Unser professionelles Team reinigt Ihre Wohnung intensiv mit speziellen Methoden und Geräten."
      },
      {
        "@type": "HowToStep",
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
              ...
              <div className="lg:col-span-2">
                ...
                >
                  ...
                  <h2 className="text-3xl font-bold text-gray-900 mb-4 md:mb-6">Warum eine professionelle Grundreinigung sinnvoll ist</h2>
                  <p className="text-lg text-gray-700 mb-4 md:mb-6 leading-relaxed">
                    Eine professionelle Grundreinigung bietet zahlreiche Vorteile, die über die normale Unterhaltsreinigung hinausgehen. Sie entfernt tief sitzenden Schmutz, Kalkablagerungen, Fettspuren und andere hartnäckige Verschmutzungen, die bei der regelmässigen Reinigung nicht erreicht werden. Eine Grundreinigung sollte idealerweise ein- bis zweimal jährlich durchgeführt werden, um Ihr Zuhause in optimalem Zustand zu halten. Professionelle Reinigungskräfte verfügen über das Fachwissen, spezielle Geräte und intensive Reinigungsmethoden, um auch schwer zugängliche Stellen gründlich zu reinigen. Zudem trägt eine regelmässige Grundreinigung zur Gesundheit bei, indem sie Allergene, Bakterien und Viren effektiv entfernt und die Raumluftqualität verbessert.
                  </p>
                  
                  {/* H2: Unsere Leistungen im Bereich Grundreinigung */}
                  <h2 className="text-3xl font-bold text-gray-900 mt-8 md:mt-12 mb-4 md:mb-6">Unsere Leistungen im Bereich Grundreinigung</h2>
                  <p className="text-lg text-gray-700 mb-4 md:mb-6 leading-relaxed">
                    Unser Netzwerk geprüfter Reinigungsfirmen bietet ein umfassendes Leistungsspektrum für die Grundreinigung. Dazu gehören die intensive Reinigung aller Räume, inklusive Küche, Badezimmer, Wohnzimmer und Schlafzimmer. Wir bieten Grundreinigung für verschiedene Anlässe: Einzug, Auszug, nach Renovierungsarbeiten oder periodisch zur intensiven Pflege. Alle unsere Partnerfirmen arbeiten mit modernsten Reinigungstechniken, speziellen Geräten wie Dampfreinigern und umweltfreundlichen Reinigungsmitteln. Besonders wichtig: Alle Reinigungsfirmen in unserem Netzwerk sind versichert, haben Erfahrung mit intensiven Reinigungen und verwenden professionelle Methoden für alle Arten von Verschmutzungen.
                  </p>
                  ...
                  <h2 className="text-3xl font-bold text-gray-900 mt-8 md:mt-12 mb-4 md:mb-6">Vorteile unserer gründlichen Grundreinigung</h2>
                  <p className="text-lg text-gray-700 mb-4 md:mb-6 leading-relaxed">
                    Eine gründliche Grundreinigung bietet zahlreiche Vorteile gegenüber der normalen Unterhaltsreinigung. Sie entfernt tief sitzenden Schmutz und Allergene, die bei oberflächlicher Reinigung zurückbleiben. Sie verlängert die Lebensdauer von Möbeln und Oberflächen, indem sie Ablagerungen und Verschmutzungen entfernt, die langfristig Schäden verursachen können. Eine Grundreinigung verbessert die Raumluftqualität erheblich und erleichtert die tägliche Unterhaltsreinigung, da weniger Schmutz vorhanden ist. Professionelle Reinigungsfirmen verwenden spezielle Methoden und Geräte, die für intensive Reinigungen entwickelt wurden. Durch den Vergleich mehrerer Offerten über unsere Plattform können Sie bis zu 40% sparen.
                  </p>
                  ...
                  <h2 className="text-3xl font-bold text-gray-900 mt-8 md:mt-12 mb-4 md:mb-6">Was bei einer umfassenden Grundreinigung gereinigt wird</h2>
                  <p className="text-lg text-gray-700 mb-4 md:mb-6 leading-relaxed">
                    Eine umfassende Grundreinigung beinhaltet die intensive Reinigung aller Räume und Bereiche. Dazu gehört die Entfernung aller Möbel zur Reinigung darunter und dahinter, die gründliche Reinigung aller Böden inklusive Ecken, Kanten und schwer zugänglicher Stellen. Alle Oberflächen werden intensiv gereinigt, inklusive Regale, Schränke, Fensterbänke und Heizkörper. In der Küche werden Herd, Backofen, Kühlschrank, Spüle, Arbeitsflächen und Schränke innen und aussen gereinigt. Das Badezimmer wird komplett gereinigt, inklusive Entkalkung, Reinigung von Toilette, Dusche, Badewanne, Waschbecken und Fliesen. Fenster werden innen und aussen gereinigt, inklusive Rahmen und Bänke. Heizkörper, Lüftungsgittern, Lampen und alle schwer zugänglichen Stellen werden gründlich gereinigt.
                  </p>

                  {/* H2: Grundreinigung für verschiedene Anlässe (Einzug, Auszug, nach Renovation) */}
                  <h2 className="text-3xl font-bold text-gray-900 mt-8 md:mt-12 mb-4 md:mb-6">Grundreinigung für verschiedene Anlässe (Einzug, Auszug, nach Renovation)</h2>
                  <p className="text-lg text-gray-700 mb-4 md:mb-6 leading-relaxed">
                    Professionelle Grundreinigung wird für verschiedene Anlässe angeboten, die alle intensive Reinigung erfordern. Grundreinigung bei Einzug sorgt dafür, dass Sie in eine saubere, hygienische Wohnung einziehen. Grundreinigung bei Auszug stellt sicher, dass die Wohnung den Anforderungen für die Übergabe entspricht. Grundreinigung nach Renovierungsarbeiten entfernt Bauschutt, Staub und Farbreste, die bei Renovierungen entstehen. Periodische Grundreinigung (ein- bis zweimal jährlich) hält Ihr Zuhause in optimalem Zustand und entfernt tief sitzenden Schmutz, der sich über Zeit ansammelt. Professionelle Reinigungsfirmen passen ihre Methoden und den Umfang der Reinigung an den spezifischen Anlass an.
                  </p>
                  ...
                  <h2 className="text-3xl font-bold text-gray-900 mt-8 md:mt-12 mb-4 md:mb-6">Ablauf unserer Grundreinigung – Schritt für Schritt</h2>
                  <p className="text-lg text-gray-700 mb-4 md:mb-6 leading-relaxed">
                  ...
                  <h2 className="text-3xl font-bold text-gray-900 mt-8 md:mt-12 mb-4 md:mb-6">Warum wir der richtige Partner für Ihre Grundreinigung sind</h2>
                  <p className="text-lg text-gray-700 mb-4 md:mb-6 leading-relaxed">
                    Mit über 12 Jahren Erfahrung im Bereich Reinigungsdienstleistungen sind wir der vertrauenswürdige Partner für Ihre Grundreinigung. Unser Netzwerk umfasst nur geprüfte, versicherte Reinigungsfirmen, die höchste Qualitätsstandards erfüllen und Erfahrung mit intensiven Reinigungen haben. Alle Partnerfirmen verwenden moderne, umweltfreundliche Reinigungsmittel und haben die richtige Ausrüstung für intensive Reinigungen, wie Dampfreiniger und spezielle Reinigungsmittel. Wir haben bereits über 500 zufriedene Kunden geholfen, die richtige Grundreinigungsfirma zu finden. Unser Service ist komplett kostenlos und unverbindlich – Sie zahlen nur für die Reinigung selbst, nicht für unsere Vermittlung. Zudem können Sie durch den Vergleich mehrerer Offerten bis zu 40% sparen.
                  </p>
                  ...
                  <div className="mt-6 md:mt-12">
                    <h2 className="text-3xl font-bold text-gray-900 mb-4 md:mb-6">Häufig gestellte Fragen zur Grundreinigung</h2>
                    <p className="text-lg text-gray-700 mb-6 md:mb-8 leading-relaxed">
                      Häufig gestellte Fragen zur professionellen Grundreinigung: Was kostet eine Grundreinigung? Wann sollte eine Grundreinigung durchgeführt werden? Was beinhaltet eine umfassende Grundreinigung? Wie lange dauert eine Grundreinigung? Was ist der Unterschied zwischen Grundreinigung und Unterhaltsreinigung? Welche Reinigungsmethoden werden verwendet? Werden umweltfreundliche Reinigungsmittel verwendet? Diese und weitere Fragen beantworten wir Ihnen gerne. Über unsere Plattform können Sie Reinigungsofferten online vergleichen und dabei bis zu 40% sparen.
                    </p>
...
export default GrundreinigungPage;
