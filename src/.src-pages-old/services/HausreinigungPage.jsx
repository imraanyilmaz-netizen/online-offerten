          ...
          <div className="container mx-auto max-w-7xl px-4 sm:px-6 relative z-10">
            <div className="max-w-full">
              ...
              <div className="px-0 sm:px-4 py-4 sm:py-6 md:py-8 lg:py-12">
                ...
                >
                  Gründliche Hausreinigung mit 100% Abnahmegarantie für ein sauberes Zuhause. Über 12 Jahre Erfahrung. Reinigungsofferten online vergleichen und bis zu 40% sparen.
                </motion.p>
...
export default HausreinigungPage;
