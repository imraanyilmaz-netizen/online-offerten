...
const ReinigungPage = () => {
  ...
  const canonicalUrl = "https://online-offerten.ch/reinigung";
      ...
      <div className="bg-slate-50">
        ...
        <div className="container mx-auto max-w-navbar px-4 md:px-6 py-12 md:py-20 space-y-16 md:space-y-24">
          ...
          <motion.div 
            ...
            className="bg-gradient-to-br from-gray-50 to-white rounded-xl p-6 md:p-8 border border-gray-200 shadow-sm"
          >
          ...
          <section id="cta" className="text-center bg-gradient-to-r from-blue-600 to-blue-800 text-white py-16 px-6 rounded-2xl shadow-2xl">
            ...
            <motion.p
              ...
              className="max-w-2xl mx-auto text-blue-200 mb-8"
            >
