...
const TermsAndConditionsPage = () => {
  const metaTitle = "Allgemeine Geschäftsbedingungen | Online-Offerten.ch";
  const metaDescription = "Lesen Sie unsere Allgemeinen Geschäftsbedingungen (AGB) für Partnerfirmen. Gültig für Umzugsfirmen in der Schweiz.";
