...
const StarRating = ({ rating, setRating, interactive = true }) => {
    ...
    const calculateRating = useCallback((event) => {
    ...
    const handleInteraction = useCallback((event, isSetting) => {
...
const PartnerReviewForm = ({ partner, quote, onBack, onComplete }) => {
...
const PlatformReviewForm = ({ quote, onComplete }) => {
    const { toast } = useToast();
    const [loading, setLoading] = useState(false);
