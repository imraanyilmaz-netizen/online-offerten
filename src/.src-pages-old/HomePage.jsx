...
const ServiceCard = React.memo(({ serviceId, label, subLabel, icon, onClick, isSelected, colors }) => {
  return (
    <div
...
const ReviewCard = ({ review, index }) => {
  ...
  const DetailRating = ({ label, rating }) => (
...
const HomePage = () => {
  ...
  // Handlers
  const handleServiceSelection = useCallback((serviceType) => {
