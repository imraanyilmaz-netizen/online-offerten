...
const ContactPage = () => {
    ...
    const metaTitle = "Kontakt | Online-Offerten.ch - Wir sind für Sie da";
    const metaDescription = "Haben Sie Fragen oder benötigen Sie Unterstützung? Kontaktieren Sie das Team von Online-Offerten.ch per E-Mail oder über unser Kontaktformular. Wir helfen Ihnen gerne weiter.";
    const metaKeywords = "kontakt, online-offerten.ch, e-mail, telefon, adresse, kontaktformular, support";
    const canonicalUrl = "https://online-offerten.ch/kontakt";
