...
const PrivacyPolicyPage = () => {
  const metaTitle = "Datenschutzbestimmungen | Online-Offerten.ch";
  const metaDescription = "Erfahren Sie, wie wir Ihre Daten schützen. Unsere Datenschutzbestimmungen gemäss Schweizer DSG.";
