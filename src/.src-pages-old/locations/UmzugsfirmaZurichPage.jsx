...
const AdvantageItem = ({ icon: Icon, title, text, delay }) => {
  return (
    <motion.div
...
const UmzugsfirmaZurichPage = () => {
  ...
  const canonicalUrl = "https://online-offerten.ch/umzugsfirma-zuerich";
...
export default UmzugsfirmaZurichPage;
