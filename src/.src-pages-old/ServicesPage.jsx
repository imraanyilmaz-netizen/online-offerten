...
const ServicesPage = () => {
  const metaTitle = "Dienstleistungen | Umzug, Reinigung, Räumung - Online-offerten.ch";
  const metaDescription = "Entdecken Sie unsere umfassenden Dienstleistungen für Umzug, Reinigung, Räumung und mehr in der Schweiz. Fordern Sie jetzt Ihre kostenlose offerten an.";
  const metaKeywords = "umzugsfirma, reinigungsfirma, räumungsfirma, Umzugshelfer, spezialtransporte, klaviertransport, lagerung, verpackungsservice, umzugsfirma Zürich, reinigungsfirma Zürich";
  ...
  const services = [
    ...
    },
    {
      ...
      linkTo: "/service/geschaeftsumzug" 
    },
    {
      icon: <Globe size={32} />,
      ...
      linkTo: "/service/internationale-umzuege" 
    },
    {
    ...
    },
    {
      ...
      linkTo: "/service/raeumung-entsorgung" 
    },
    {
      ...
      linkTo: "/service/spezialtransporte" 
    },
    {
      ...
      linkTo: "/service/klaviertransport"
    },
    {
    ...
    "hasOfferCatalog": {
      ...
      "itemListElement": services.map(service => ({
        ...
        "itemOffered": {
          ...
          "url": `https://online-offerten.ch${service.linkTo}`
        }
      }))
    }
  };
