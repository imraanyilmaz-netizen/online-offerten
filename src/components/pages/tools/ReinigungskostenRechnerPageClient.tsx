        ...
        <section className="relative bg-background py-12 md:py-20 overflow-hidden">
          <div className="container mx-auto max-w-7xl px-4 md:px-6">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                <div className="inline-flex items-center px-4 py-2 bg-blue-100 dark:bg-blue-950/60 rounded-full text-blue-700 dark:text-blue-300 font-semibold text-sm mb-6">
                  <Calculator className="h-4 w-4 mr-2" />
                  Kostenloser Reinigungskosten-Rechner
                </div>
                <h1 className="heading-1">
                  <span className="block">Reinigungskosten berechnen:</span>
                  <span className="block text-blue-600 dark:text-blue-400 mt-2">Was kostet eine Reinigung in der Schweiz?</span>
                  <span className="block heading-4 text-muted-foreground mt-4">
              ...
              <div className="relative">
                <div className="bg-card rounded-2xl shadow-2xl border-4 border-blue-200 dark:border-blue-800 overflow-hidden">
        ...
        <div className="container mx-auto max-w-7xl px-4 md:px-6 py-12 md:py-16 space-y-12 md:space-y-20">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              <Card className="bg-card border border-border shadow-md hover:shadow-xl transition-shadow">
                ...
                <CardContent>
                  <p className="text-muted-foreground">Ihre Kaution ist geschützt</p>
                </CardContent>
              </Card>
              <Card className="bg-card border border-border shadow-md hover:shadow-xl transition-shadow">
                <CardHeader>
                ...
                <CardContent>
                  <p className="text-muted-foreground">Schnelle Entscheidungsgrundlage</p>
                </CardContent>
              </Card>
              <Card className="bg-card border border-border shadow-md hover:shadow-xl transition-shadow">
                <CardHeader>
                ...
                <CardContent>
                  <p className="text-muted-foreground">Mehrere Angebote, beste Wahl</p>
                </CardContent>
              </Card>
            </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* 1.5 Zimmer */}
              <div className="border-l-4 border-blue-500 pl-6 bg-muted/40 dark:bg-muted/25 p-4 rounded-r-lg">
                <h4 className="text-xl font-bold text-foreground mb-4">1.5 Zimmer Wohnung (30-45 m²)</h4>
              ...
              {/* 2.5 Zimmer */}
              <div className="border-l-4 border-green-500 pl-6 bg-muted/40 dark:bg-muted/25 p-4 rounded-r-lg">
                <h4 className="text-xl font-bold text-foreground mb-4">2.5 Zimmer Wohnung (45-65 m²)</h4>
                <ul className="space-y-2 text-muted-foreground">
              ...
              {/* 3.5 Zimmer */}
              <div className="border-l-4 border-yellow-500 pl-6 bg-muted/40 dark:bg-muted/25 p-4 rounded-r-lg">
                <h4 className="text-xl font-bold text-foreground mb-4">3.5 Zimmer Wohnung (65-85 m²)</h4>
                <ul className="space-y-2 text-muted-foreground">
              ...
              {/* 4.5 Zimmer */}
              <div className="border-l-4 border-purple-500 pl-6 bg-muted/40 dark:bg-muted/25 p-4 rounded-r-lg">
                <h4 className="text-xl font-bold text-foreground mb-4">4.5 Zimmer Wohnung (85-110 m²)</h4>
                <ul className="space-y-2 text-muted-foreground">
              ...
              {/* 5.5 Zimmer */}
              <div className="border-l-4 border-orange-500 pl-6 bg-muted/40 dark:bg-muted/25 p-4 rounded-r-lg">
                <h4 className="text-xl font-bold text-foreground mb-4">5.5 Zimmer Wohnung (110-140 m²)</h4>
                <ul className="space-y-2 text-muted-foreground">
              ...
              {/* 6.5 Zimmer */}
              <div className="border-l-4 border-red-500 pl-6 bg-muted/40 dark:bg-muted/25 p-4 rounded-r-lg">
                <h4 className="text-xl font-bold text-foreground mb-4">6.5 Zimmer Wohnung (140+ m²)</h4>
                <ul className="space-y-2 text-muted-foreground">
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse bg-card text-card-foreground shadow-md">
                <thead className="bg-muted">
                  <tr>
                    <th className="p-4 text-left font-bold text-foreground border border-border">Region</th>
                    <th className="p-4 text-left font-bold text-foreground border border-border">Preisaufschlag</th>
                    <th className="p-4 text-left font-bold text-foreground border border-border">Beispiel 3.5 Zimmer</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="hover:bg-muted/50">
                    <td className="p-4 border border-border font-semibold">Zürich</td>
                    <td className="p-4 border border-border">+15-20%</td>
                    <td className="p-4 border border-border">610-1'100 CHF</td>
                  </tr>
                  <tr className="hover:bg-muted/50">
                    <td className="p-4 border border-border font-semibold">Genf/Lausanne</td>
                    <td className="p-4 border border-border">+10-15%</td>
                    <td className="p-4 border border-border">580-1'060 CHF</td>
                  </tr>
                  <tr className="hover:bg-muted/50">
                    <td className="p-4 border border-border font-semibold">Basel</td>
                    <td className="p-4 border border-border">+5-10%</td>
                    <td className="p-4 border border-border">560-1'010 CHF</td>
                  </tr>
                  <tr className="hover:bg-muted/50">
                    <td className="p-4 border border-border font-semibold">Bern</td>
                    <td className="p-4 border border-border">Durchschnitt</td>
                    <td className="p-4 border border-border">530-920 CHF</td>
                  </tr>
                  <tr className="hover:bg-muted/50">
                    <td className="p-4 border border-border font-semibold">Ländliche Gebiete</td>
                    <td className="p-4 border border-border">-10-20%</td>
                    <td className="p-4 border border-border">425-735 CHF</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <section
            className="bg-gradient-to-br from-green-50 to-blue-50 dark:from-emerald-950/35 dark:to-blue-950/40 p-6 md:p-10 rounded-xl shadow-lg border border-border/60"
          >
            <h2 className="heading-2 text-center">
              So funktioniert die Offertanfrage
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-foreground mb-3">Wohnungsdetails eingeben</h3>
                <p className="text-muted-foreground">Grösse, Zustand, gewünschte Extras wie Fenster oder Backofen</p>
              </div>
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-foreground mb-3">Bis zu 5 geprüfte Angebote erhalten</h3>
                <p className="text-muted-foreground">Innerhalb von 24 Stunden vergleichbare Offerten</p>
              </div>
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-foreground mb-3">Beste Offerte auswählen und buchen</h3>
                <p className="text-muted-foreground">Direkt mit der Reinigungsfirma in Kontakt</p>
              </div>
            </div>
          ...
          >
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Wochenend-Reinigungen: <strong>+25% Aufschlag</strong>. Kurzfristige Buchungen (unter 3 Tage): <strong>+15-30%</strong>. Planen Sie Ihre <Link href="/reinigungsfirma/umzugsreinigung" className="text-green-600 hover:text-green-700 dark:text-emerald-400 dark:hover:text-emerald-300 font-semibold underline">Umzugsreinigung</Link> mindestens 2-3 Wochen im Voraus.
                </p>
              </div>
              <div>
              ...
              <div className="bg-yellow-50 dark:bg-yellow-950/25 border-l-4 border-yellow-500 dark:border-yellow-600 p-6 rounded-lg">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              <Card className="bg-red-50 dark:bg-red-950/30 border-2 border-red-200 dark:border-red-900/60">
                <CardHeader>
                  <CardTitle className="text-xl font-bold text-foreground">Selbst reinigen:</CardTitle>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-2 text-muted-foreground">
              ...
              <Card className="bg-green-50 dark:bg-emerald-950/35 border-2 border-green-200 dark:border-emerald-800/60">
                <CardHeader>
                  <CardTitle className="text-xl font-bold text-foreground">Professionelle Endreinigung:</CardTitle>
                </CardHeader>
                <CardContent>
                  <ul className="space-y-2 text-muted-foreground">
            ...
            <div className="bg-blue-50 dark:bg-blue-950/30 p-6 rounded-lg mb-6 border border-blue-200/60 dark:border-blue-900/50">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h3 className="text-xl font-bold text-foreground mb-3">Selbst machen lohnt sich wenn:</h3>
                <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-foreground mb-3">Profis beauftragen lohnt sich wenn:</h3>
                <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
          ...
          {/* 10 Spartipps */}
          <section
            className="bg-gradient-to-br from-green-50 to-yellow-50 dark:from-emerald-950/35 dark:to-yellow-950/20 p-6 md:p-10 rounded-xl shadow-lg border border-border/60"
          >
            <h2 className="heading-2">
            ...
            <ol className="space-y-4 list-decimal list-inside text-muted-foreground">
              ...
              <li className="leading-relaxed"><strong>Lokale Anbieter bevorzugen: Anfahrtskosten sparen</strong> – <Link href="/umzugsfirma" className="text-green-600 hover:text-green-700 dark:text-emerald-400 dark:hover:text-emerald-300 font-semibold underline">Reinigungsfirma aus der Nähe wählen</Link></li>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card className="bg-card border border-border shadow-md">
                <CardContent className="p-6">
                  ...
                  <p className="font-semibold text-foreground">— Markus T., Zürich</p>
                </CardContent>
              </Card>
              <Card className="bg-card border border-border shadow-md">
                <CardContent className="p-6">
                  ...
                  <p className="font-semibold text-foreground">— Sandra L., Basel</p>
                </CardContent>
              </Card>
              <Card className="bg-card border border-border shadow-md">
                <CardContent className="p-6">
                  ...
                  <p className="font-semibold text-foreground">— Philippe M., Genf</p>
                </CardContent>
              </Card>
            </div>
          </section>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="space-y-3 text-muted-foreground">
                  <li className="flex items-start">
                    <Check className="w-5 h-5 text-green-600 dark:text-emerald-400 mr-3 mt-1 flex-shrink-0" />
              ...
              <div>
                ...
                <ul className="space-y-3 text-muted-foreground">
                  <li className="flex items-start">
                    <Package className="w-5 h-5 text-blue-600 dark:text-blue-400 mr-3 mt-1 flex-shrink-0" />
                ...
                <div className="mt-6 bg-red-50 dark:bg-red-950/30 border-l-4 border-red-500 dark:border-red-600 p-4 rounded">
                  <h3 className="text-xl font-bold text-foreground mb-3">Rote Flaggen: Diese Ausschlüsse sind unzulässig</h3>
                  <ul className="space-y-2 text-muted-foreground">
                    <li className="flex items-start">
          ...
          {/* FAQ Section */}
          <section
            className="bg-card text-card-foreground rounded-xl shadow-lg border border-border border-t-4 border-t-blue-500 dark:border-t-blue-400 p-6 md:p-8"
          >
            <h2 className="heading-2">
          ...
          >
            ...
            <Button onClick={handleConclusionCta} size="lg" className="bg-white text-green-700 hover:bg-gray-100 dark:bg-card dark:text-primary dark:border dark:border-border dark:hover:bg-muted font-bold group px-10 py-4 rounded-lg shadow-lg hover:shadow-xl transition-all transform hover:scale-105">
