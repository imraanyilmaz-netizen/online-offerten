    ...
    <>
      ...
      <div className="bg-slate-50">
        <ReinigungServiceHero
          breadcrumbCurrent="Grundreinigung"
          backgroundImageUrl="https://online-offerten.ch/reinigungsfirma/grundreinigung_hero.png"
          title="Professionelle Grundreinigung"
          intro="Gründliche und intensive Grundreinigung für ein tiefenreines Zuhause. Professionelle Tiefenreinigung aller Bereiche. Reinigungsofferten online vergleichen und bis zu 40% sparen."
