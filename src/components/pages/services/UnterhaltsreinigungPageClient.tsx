    ...
    <>
      ...
      <div className="bg-slate-50">
        <ReinigungServiceHero
          breadcrumbCurrent="Unterhaltsreinigung"
          backgroundImageUrl="https://online-offerten.ch/reinigungsfirma/unterhaltsreinigung_hero.png"
          title="Professionelle Unterhaltsreinigung"
          intro="Regelmässige Unterhaltsreinigung für ein kontinuierlich sauberes Zuhause. Flexible Reinigungsfrequenz – wöchentlich, zweiwöchentlich oder monatlich. Reinigungsofferten online vergleichen und bis zu 40% sparen."
