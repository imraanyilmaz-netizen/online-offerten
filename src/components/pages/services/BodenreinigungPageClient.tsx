    ...
    <>
      ...
      <div className="bg-slate-50">
        <ReinigungServiceHero
          breadcrumbCurrent="Bodenreinigung"
          backgroundImageUrl="https://online-offerten.ch/reinigungsfirma/bodenreinigung.png"
          title="Professionelle Bodenreinigung"
          intro="Professionelle Bodenreinigung für alle Bodenbeläge. Teppich, Parkett, Fliesen, Laminat, Vinyl, Stein. Reinigungsofferten online vergleichen und bis zu 40% sparen."
