    ...
    <>
      ...
      <div className="bg-slate-50">
        <ReinigungServiceHero
          breadcrumbCurrent="Wohnungsreinigung"
          backgroundImageUrl="https://online-offerten.ch/reinigungsfirma/wohnungsreinigung_hero_header.webp"
          title="Professionelle Wohnungsreinigung mit Abnahmegarantie"
          intro="Gründliche Wohnungsreinigung mit 100% Abnahmegarantie für eine sorgenfreie Übergabe. Reinigungsofferten online vergleichen und bis zu 40% sparen."
