    ...
    <>
      ...
      <div className="bg-slate-50">
        <ReinigungServiceHero
          breadcrumbCurrent="Hofreinigung"
          backgroundImageUrl="https://online-offerten.ch/reinigungsfirma/hofreinigung_hochdruckreiniger.png"
          title="Professionelle Hofreinigung"
          intro="Professionelle Reinigung von Höfen, Einfahrten, Terrassen und Aussenbereichen. Gründliche Reinigung für ein gepflegtes Äusseres. Reinigungsofferten online vergleichen und bis zu 40% sparen."
