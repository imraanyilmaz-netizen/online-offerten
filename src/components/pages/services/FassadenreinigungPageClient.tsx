    ...
    <>
      ...
      <div className="bg-slate-50">
        <ReinigungServiceHero
          breadcrumbCurrent="Fassadenreinigung"
          backgroundImageUrl="https://online-offerten.ch/reinigungsfirma/fassadenreinigung_hochdruck_profi.png"
          title="Professionelle Fassadenreinigung"
          intro="Professionelle Fassadenreinigung für ein gepflegtes Äusseres. Entfernung von Algen, Moos und Verschmutzungen. Reinigungsofferten online vergleichen und bis zu 40% sparen."
