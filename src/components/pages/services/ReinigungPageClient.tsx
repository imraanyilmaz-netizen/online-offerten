            ...
            <article className="max-w-4xl space-y-10">
              ...
              <div className="space-y-4 rounded-2xl border border-gray-200 bg-slate-50 p-6 md:p-8">
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  <Link href="/reinigung/endreinigung" className="inline-flex items-center rounded-lg border border-blue-200 bg-white px-4 py-2 text-sm font-semibold text-blue-700 hover:bg-blue-50 transition-colors">Endreinigung</Link>
