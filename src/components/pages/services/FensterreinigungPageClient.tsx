    ...
    <>
      ...
      <div className="bg-slate-50">
        <ReinigungServiceHero
          breadcrumbCurrent="Fensterreinigung"
          backgroundImageUrl="https://online-offerten.ch/reinigungsfirma/fensterreinigung_profi_bei_der_arbeit.png"
          title="Professionelle Fensterreinigung"
          intro="Professionelle Fensterreinigung für strahlend saubere Fenster. Innen- und Aussenreinigung. Reinigungsofferten online vergleichen und bis zu 40% sparen."
