          ...
          <div className="grid lg:grid-cols-3 gap-8 md:gap-12 items-start">
            <main className="lg:col-span-2 bg-card p-6 md:p-10 rounded-2xl border border-border/60 shadow-xl space-y-10">
              <Section className="border-t-0 pt-0">
                <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Von den Alpen ans Mittelmeer: Ihr Umzug nach Italien</h2>
                ...
                <p className="text-muted-foreground leading-relaxed">Dieser Leitfaden ist Ihr zuverlässiger Partner auf diesem Weg. Wir beleuchten alle entscheidenden Etappen: von einer realistischen Kosteneinschätzung über die Tücken der italienischen Bürokratie (Stichwort 'Codice Fiscale') bis hin zur Wahl des perfekten Umzugsunternehmens. Unser Ziel ist es, Ihnen zu helfen, Fallstricke zu vermeiden, Kosten zu sparen und Ihren Start in Italien so angenehm wie möglich zu gestalten.</p>
                 <p className="text-muted-foreground leading-relaxed mt-4">Durch den Vergleich von qualifizierten Umzugsspediteuren, die auf die Route Schweiz-Italien spezialisiert sind, stellen Sie sicher, dass Ihr Hab und Gut sicher und pünktlich ankommt. So können Sie sich auf das Wesentliche konzentrieren: den ersten Espresso in Ihrer neuen Nachbarschaftsbar, das Erkunden antiker Gassen oder das Rauschen des Meeres.</p>
              </Section>

              <Section>
                <SectionTitle icon={ShieldCheck} title="Clever starten: Warum sich der Vergleich von Umzugsfirmen auszahlt" />
                <p className="text-muted-foreground leading-relaxed mb-8">Ein Umzug nach Italien kann je nach Anbieter stark im Preis variieren. Ein sorgfältiger Vergleich von Offerten ist der effektivste Weg, um das beste Preis-Leistungs-Verhältnis zu finden und sicherzustellen, dass das Unternehmen die spezifischen Anforderungen für Italien-Umzüge erfüllt.</p>
              ...
              <Section>
                ...
                <p className="text-muted-foreground leading-relaxed mb-6">Eine gute Organisation ist entscheidend für einen stressfreien Umzug. Die Planung sollte frühzeitig beginnen, um alle administrativen und logistischen Aufgaben ohne Zeitdruck zu erledigen.</p>
                ...
                <h3 className="text-2xl font-semibold text-foreground mt-10 mb-4">Ihre Umzugs-Checkliste für Italien:</h3>
              ...
              <Section>
                <SectionTitle icon={FileText} title="Zoll (Dogana): Was Sie für die Einfuhr wissen müssen" />
                 <p className="text-muted-foreground leading-relaxed mb-6">Da die Schweiz kein EU-Mitglied ist, muss Ihr gesamtes Umzugsgut beim italienischen Zoll angemeldet werden. Unter bestimmten Voraussetzungen kann Ihr Haushalt als 'massserizie di trasloco' (Umzugsgut) zoll- und mehrwertsteuerfrei eingeführt werden.</p>
                 <p className="text-muted-foreground leading-relaxed mb-6">Dafür müssen Sie Ihren Hauptwohnsitz nachweislich nach Italien verlegen, und die eingeführten Güter müssen sich seit mindestens sechs Monaten in Ihrem Besitz befinden. Eine genaue, bewertete Inventarliste (in zweifacher Ausfertigung, auf Italienisch) ist zwingend erforderlich.</p>
              ...
              <Section>
                ...
                <div className="bg-muted/50 p-6 rounded-lg border border-border mt-8">
                  ...
                  <p className="text-xs text-muted-foreground mt-4 italic">*Diese Preise sind Schätzungen. Die tatsächlichen Kosten hängen stark vom Anbieter, der Saison und den gewählten Zusatzleistungen ab.</p>
                </div>
            ...
            <aside className="lg:col-span-1 space-y-8 self-start sticky top-28">
              ...
              >
                ...
                <p className="text-sm text-muted-foreground mt-2">Vergleichen Sie Firmen, die sich mit den Besonderheiten von Umzügen nach Italien auskennen – von der Maut bis zur Bürokratie.</p>
              </div>
              <div
