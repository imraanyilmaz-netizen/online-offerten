...
const Section = ({ children, className = '' }: any) => (
  <section
    className={`py-8 md:py-12 border-t border-border ${className}`}
  >
    {children}
  </section>
);
      ...
      <div className="bg-gradient-to-b from-background via-muted/30 to-background">
        ...
        <div className="container mx-auto max-w-7xl px-4 md:px-6 py-12 md:py-16">
          <div className="items-start">
            <main className="bg-card p-6 md:p-10 rounded-2xl border border-border/60 shadow-xl space-y-8">
              ...
              <Section>
                ...
                <div className="space-y-4 mb-6">
                  {[
                    ...
                    <div key={i} className="flex items-start bg-muted/50 p-4 rounded-lg border border-border">
                  ...
                  <table className="w-full text-left">
                    <thead>
                      <tr className="border-b border-border">
                        <th className="py-3 font-semibold text-muted-foreground">Wohnungsgrösse</th>
                        <th className="py-3 font-semibold text-muted-foreground text-right">Typische Kosten</th>
                      </tr>
                    </thead>
                    <tbody>
                      {costTable.map((row, i) => (
              ...
              <Section>
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/40 dark:to-emerald-950/30 border border-green-200 dark:border-green-800 rounded-2xl p-8 text-center">
                  ...
                  <p className="text-sm text-muted-foreground mt-4">100% kostenlos und unverbindlich. Bearbeitung Ihrer Anfrage innerhalb von 24–48 Stunden.</p>
