  ...
  const sections = [
    ...
    },
    {
      ...
      content: [
        ...
        "",
        "<strong>b) Analyse und Performance-Messung</strong> – nur mit Ihrer Einwilligung:",
        "• Google Tag Manager und Google Analytics 4 (Messung anonymisierter Nutzungsstatistiken)<br>• Vercel Speed Insights (Messung der Ladezeiten)",
        "",
