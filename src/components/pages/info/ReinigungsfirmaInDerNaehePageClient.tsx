...
const ReinigungsfirmaInDerNaehePageClient = () => {
  ...
  return (
    <>
      {/* Hero Section */}
      <section className="relative py-12 md:py-20 overflow-hidden bg-gradient-to-br from-blue-50 via-white to-cyan-50 dark:from-background dark:via-background dark:to-sky-950/30">
        ...
        <div className="container mx-auto max-w-7xl px-4 md:px-6 relative z-10">
          ...
          <nav className="mb-6" aria-label="Breadcrumb">
            <ol className="flex items-center space-x-2 text-sm text-muted-foreground">
              <li>
                <Link href="/" className="hover:text-blue-600 dark:hover:text-sky-400 transition-colors">Startseite</Link>
              </li>
              <li><ChevronRightIcon className="w-4 h-4 text-muted-foreground/70" /></li>
              <li className="text-foreground font-medium" aria-current="page">Reinigungsfirma</li>
            </ol>
          </nav>
          ...
          <div className="grid md:grid-cols-5 gap-12 items-center">
            ...
            <div className="md:col-span-3">
              <div className="inline-flex items-center px-4 py-2 bg-blue-100 dark:bg-sky-950/50 rounded-full text-blue-700 dark:text-sky-300 font-semibold text-sm mb-3 border border-blue-200/60 dark:border-sky-800">
              ...
              <p className="text-base sm:text-lg text-muted-foreground mb-8 leading-relaxed">
                Ob{' '}
                <strong className="font-semibold text-foreground">Umzugsreinigung</strong>,{' '}
                <strong className="font-semibold text-foreground">Endreinigung</strong> mit Abnahmegarantie,{' '}
                <strong className="font-semibold text-foreground">Wohnungsreinigung</strong> bei Auszug oder{' '}
                <strong className="font-semibold text-foreground">Büroreinigung</strong>: Beschreiben Sie Ihr Projekt einmal und holen Sie bis zu fünf{' '}
                <strong className="font-semibold text-foreground">Reinigungsofferten</strong> von geprüften Anbietern ein – kostenlos, unverbindlich, in der ganzen Schweiz.
              </p>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-3 gap-2 sm:gap-3 mb-6">
                ...
                >
                  <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg flex items-center justify-center flex-shrink-0 bg-blue-100 dark:bg-sky-950/50 group-hover:bg-blue-500 dark:group-hover:bg-sky-600 transition-colors">
                    <Sparkles className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 dark:text-sky-400 group-hover:text-white transition-colors" />
                  </div>
                  <div className="flex-1 text-left sm:text-center">
                    <p className="font-semibold text-sm sm:text-base text-foreground">Endreinigung</p>
                    <p className="text-xs text-muted-foreground mt-0.5">mit Abnahmegarantie</p>
                  </div>
                </Link>
                ...
                >
                  <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg flex items-center justify-center flex-shrink-0 bg-purple-100 dark:bg-purple-950/45 group-hover:bg-purple-500 dark:group-hover:bg-purple-600 transition-colors">
                    <Home className="w-4 h-4 sm:w-5 sm:h-5 text-purple-600 dark:text-purple-300 group-hover:text-white transition-colors" />
                  </div>
                  <div className="flex-1 text-left sm:text-center">
                    <p className="font-semibold text-sm sm:text-base text-foreground">Wohnungsreinigung</p>
                    <p className="text-xs text-muted-foreground mt-0.5">Privathaushalte</p>
                  </div>
                </Link>
                ...
                >
                  ...
                  <div className="flex-1 text-left sm:text-center">
                    <p className="font-semibold text-sm sm:text-base text-foreground">Büroreinigung</p>
                    <p className="text-xs text-muted-foreground mt-0.5">Gewerberäume</p>
                  </div>
                </Link>
                ...
                >
                  <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg flex items-center justify-center flex-shrink-0 bg-amber-100 dark:bg-amber-950/40 group-hover:bg-amber-500 dark:group-hover:bg-amber-600 transition-colors">
                    <Droplets className="w-4 h-4 sm:w-5 sm:h-5 text-amber-600 dark:text-amber-400 group-hover:text-white transition-colors" />
                  </div>
                  <div className="flex-1 text-left sm:text-center">
                    <p className="font-semibold text-sm sm:text-base text-foreground">Grundreinigung</p>
                    <p className="text-xs text-muted-foreground mt-0.5">Tiefenreinigung</p>
                  </div>
                </Link>
                ...
                >
                  <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg flex items-center justify-center flex-shrink-0 bg-teal-100 dark:bg-teal-950/45 group-hover:bg-teal-500 dark:group-hover:bg-teal-600 transition-colors">
                    <Sparkle className="w-4 h-4 sm:w-5 sm:h-5 text-teal-600 dark:text-teal-400 group-hover:text-white transition-colors" />
                  </div>
                  <div className="flex-1 text-left sm:text-center">
                    <p className="font-semibold text-sm sm:text-base text-foreground">Fensterreinigung</p>
                    <p className="text-xs text-muted-foreground mt-0.5">Innen & Aussen</p>
                  </div>
                </Link>
                ...
                >
                  <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg flex items-center justify-center flex-shrink-0 bg-indigo-100 dark:bg-indigo-950/45 group-hover:bg-indigo-500 dark:group-hover:bg-indigo-600 transition-colors">
                    <Wrench className="w-4 h-4 sm:w-5 sm:h-5 text-indigo-600 dark:text-indigo-400 group-hover:text-white transition-colors" />
                  </div>
                  <div className="flex-1 text-left sm:text-center">
                    <p className="font-semibold text-sm sm:text-base text-foreground">Baureinigung</p>
                    <p className="text-xs text-muted-foreground mt-0.5">Nach Umbau/Neubau</p>
                  </div>
                </Link>
              </div>
            ...
            <div className="relative md:col-span-2">
              ...
              {/* Floating Badge */}
              <div className="absolute -bottom-4 -left-4 bg-blue-600 dark:bg-sky-700 text-white px-5 py-3 rounded-xl shadow-lg hidden md:block">
                <p className="text-sm font-bold">Professionelle Reinigung</p>
                <p className="text-xs text-blue-100 dark:text-sky-200">In Ihrer Region</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 md:py-16 bg-gradient-to-b from-gray-50 to-white dark:from-muted/20 dark:to-background">
        <div className="container mx-auto max-w-7xl px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
            <Card className="h-full border-2 border-border hover:border-blue-500 dark:hover:border-sky-500 bg-card transition-colors">
              <CardHeader>
      ...
      <section className="py-12 md:py-16 bg-background">
        <div className="container mx-auto max-w-7xl px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="relative">
                {index < 2 && (
                  <div className="hidden md:block absolute top-12 left-full w-full h-0.5 bg-blue-200 dark:bg-sky-800 z-0" style={{ width: 'calc(100% - 3rem)' }} />
                )}
                <Card className="relative z-10 h-full border-2 border-blue-200 dark:border-sky-800 hover:border-blue-500 dark:hover:border-sky-500 bg-card transition-colors">
                  <CardHeader className="text-center">
                    <div className="bg-blue-600 dark:bg-sky-600 text-white rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 text-2xl font-bold">
                      {step.number}
                    </div>
                    <div className="flex justify-center mb-4">
                      <div className="bg-blue-100 dark:bg-sky-950/50 p-3 rounded-lg">
                        <step.icon className="h-6 w-6 text-blue-600 dark:text-sky-400" />
                      </div>
                    </div>
          ...
          <div className="mt-8 bg-gray-50 dark:bg-muted/30 rounded-lg p-6 border border-border">
            <p className="text-body italic">
      ...
      <section className="py-10 md:py-12 bg-gradient-to-b from-background to-muted/20 border-y border-border">
        <div className="container mx-auto max-w-7xl px-4 md:px-6">
          ...
          <div className="flex flex-wrap gap-2">
            {REINIGUNGSFIRMA_STAEDTE.map(({ label, slug }) => (
              <Link
                ...
                className="inline-flex items-center px-4 py-2 rounded-full border-2 border-border bg-card text-foreground font-medium text-sm hover:border-blue-500 dark:hover:border-sky-500 hover:bg-blue-50 dark:hover:bg-sky-950/35 transition-colors"
              >
                {label}
              </Link>
            ))}
        ...
        <div className="container mx-auto max-w-7xl px-4 md:px-6">
          ...
          <div className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-card rounded-xl p-6 border border-border shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center mb-3">
                  <div className="bg-purple-100 dark:bg-purple-950/40 p-2 rounded-lg mr-3">
                ...
                <Link href="/kostenlose-offerte-anfordern?service=reinigung&step=3&reinigungArt=wohnungsreinigung" className="inline-flex items-center text-blue-600 dark:text-sky-400 font-semibold text-sm mt-3 hover:text-blue-800 dark:hover:text-sky-300 transition-colors">
              ...
              <div className="bg-card rounded-xl p-6 border border-border shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center mb-3">
                  <div className="bg-blue-100 dark:bg-sky-950/45 p-2 rounded-lg mr-3">
                ...
                <Link href="/kostenlose-offerte-anfordern?service=reinigung&step=3&reinigungArt=umzugsreinigung" className="inline-flex items-center text-blue-600 dark:text-sky-400 font-semibold text-sm mt-3 hover:text-blue-800 dark:hover:text-sky-300 transition-colors">
                  Offerte anfordern <ArrowRight className="h-4 w-4 ml-1" />
                </Link>
              </div>
              ...
              <div className="bg-card rounded-xl p-6 border border-border shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center mb-3">
                  <div className="bg-teal-100 dark:bg-teal-950/40 p-2 rounded-lg mr-3">
                ...
                <Link href="/kostenlose-offerte-anfordern?service=reinigung&step=2" className="inline-flex items-center text-blue-600 dark:text-sky-400 font-semibold text-sm mt-3 hover:text-blue-800 dark:hover:text-sky-300 transition-colors">
                  Offerte anfordern <ArrowRight className="h-4 w-4 ml-1" />
                </Link>
              </div>
              ...
              <div className="bg-card rounded-xl p-6 border border-border shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center mb-3">
                  <div className="bg-amber-100 dark:bg-amber-950/40 p-2 rounded-lg mr-3">
                ...
                <Link href="/kostenlose-offerte-anfordern?service=reinigung&step=3&reinigungArt=grundreinigung" className="inline-flex items-center text-blue-600 dark:text-sky-400 font-semibold text-sm mt-3 hover:text-blue-800 dark:hover:text-sky-300 transition-colors">
                  Offerte anfordern <ArrowRight className="h-4 w-4 ml-1" />
                </Link>
              </div>
              ...
              <div className="bg-card rounded-xl p-6 border border-border shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center mb-3">
                  <div className="bg-teal-100 dark:bg-teal-950/40 p-2 rounded-lg mr-3">
                    <Sparkle className="h-5 w-5 text-teal-600 dark:text-teal-400" />
                  </div>
              ...
              <div className="bg-card rounded-xl p-6 border border-border shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center mb-3">
                  <div className="bg-green-100 dark:bg-emerald-950/40 p-2 rounded-lg mr-3">
                    <Home className="h-5 w-5 text-green-600 dark:text-emerald-400" />
                  </div>
                ...
                <Link href="/kostenlose-offerte-anfordern?service=reinigung&step=3&reinigungArt=hausreinigung" className="inline-flex items-center text-blue-600 dark:text-sky-400 font-semibold text-sm mt-3 hover:text-blue-800 dark:hover:text-sky-300 transition-colors">
                  Offerte anfordern <ArrowRight className="h-4 w-4 ml-1" />
                </Link>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-card rounded-xl p-6 border border-border shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center mb-3">
                  <div className="bg-emerald-100 dark:bg-emerald-950/40 p-2 rounded-lg mr-3">
                ...
                <Link href="/kostenlose-offerte-anfordern?service=reinigung&step=3&reinigungArt=buero" className="inline-flex items-center text-blue-600 dark:text-sky-400 font-semibold text-sm mt-3 hover:text-blue-800 dark:hover:text-sky-300 transition-colors">
                  Offerte anfordern <ArrowRight className="h-4 w-4 ml-1" />
                </Link>
              </div>
              ...
              <div className="bg-card rounded-xl p-6 border border-border shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center mb-3">
                  <div className="bg-indigo-100 dark:bg-indigo-950/40 p-2 rounded-lg mr-3">
                ...
                <Link href="/kostenlose-offerte-anfordern?service=reinigung&step=3&reinigungArt=baureinigung" className="inline-flex items-center text-blue-600 dark:text-sky-400 font-semibold text-sm mt-3 hover:text-blue-800 dark:hover:text-sky-300 transition-colors">
                  Offerte anfordern <ArrowRight className="h-4 w-4 ml-1" />
                </Link>
              </div>
              ...
              <div className="bg-card rounded-xl p-6 border border-border shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center mb-3">
                  <div className="bg-rose-100 dark:bg-rose-950/35 p-2 rounded-lg mr-3">
              ...
              <div className="bg-card rounded-xl p-6 border border-border shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center mb-3">
                  <div className="bg-orange-100 dark:bg-orange-950/35 p-2 rounded-lg mr-3">
      ...
      <section className="py-12 md:py-16 bg-background">
        <div className="container mx-auto max-w-7xl px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-blue-50 dark:bg-sky-950/25 rounded-xl p-6 border border-blue-100 dark:border-sky-800/50">
      ...
      <section
        className="py-12 md:py-16 bg-gradient-to-b from-gray-50 to-white dark:from-muted/20 dark:to-background border-t border-border"
          ...
          <div className="grid md:grid-cols-5 gap-8 md:gap-12 items-start">
              ...
              <Accordion type="single" collapsible className="w-full">
                {faqItems.map((item, index) => (
                  <AccordionItem key={index} value={`item-${index}`} className="border-b border-border">
                    <AccordionTrigger className="text-left font-semibold text-foreground hover:text-blue-600 dark:hover:text-sky-400">
            ...
            <div className="relative md:col-span-2">
              ...
              <div className="absolute -bottom-4 -left-4 bg-blue-600 dark:bg-sky-700 text-white px-5 py-3 rounded-xl shadow-lg hidden md:block">
                ...
                <p className="text-xs text-blue-100 dark:text-sky-200">Rund um Reinigungsfirmen</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* CTA Section */}
      <section className="py-12 md:py-16 bg-gradient-to-br from-blue-50 via-white to-cyan-50 dark:from-background dark:via-background dark:to-sky-950/30">
        <div className="container mx-auto max-w-7xl px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <Button
              ...
              size="lg"
              className="bg-blue-600 dark:bg-sky-600 text-white hover:bg-blue-700 dark:hover:bg-sky-500 text-lg px-8 py-6 shadow-xl"
            >
            ...
            <div className="mt-6 flex flex-wrap justify-center gap-6 text-sm text-foreground/90">
              <div className="flex items-center">
                <CheckCircle className="h-5 w-5 text-blue-600 dark:text-sky-400 mr-2" />
                <span>100% kostenlos</span>
              </div>
