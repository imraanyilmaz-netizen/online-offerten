...
import BernSidebar from '@/src/components/locations/BernSidebar';
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from '@/components/ui/accordion';
import ServiceGrid from '@/components/pages/locations/ServiceGrid.client';

/** Partnerliste „Geprüfte Umzugsfirmen“ erst anzeigen, wenn mindestens so viele aktive Bern-Partner gelistet werden. */
const BERN_PARTNER_SECTION_MIN_COUNT = 10
  ...
  return (
    <>
      <div className="bg-white overflow-x-hidden">
        ...
        <section className="py-12 md:py-16 bg-white">
          <div className="container mx-auto max-w-7xl px-4 md:px-6">
            <div className="grid lg:grid-cols-12 gap-8 lg:gap-12">
              {/* Text: auf Mobile unter der Sidebar; auf Desktop links */}
              ...
              {/* Sidebar: auf Mobile zuerst; auf Desktop rechts */}
        ...
        {bernPartners && bernPartners.length >= BERN_PARTNER_SECTION_MIN_COUNT && (
