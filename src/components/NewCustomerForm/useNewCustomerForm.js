...
const initialFormData = {
  ...
  additional_services_packing: false,
  additional_services_furniture_lift: false,
  additional_services_disposal: false,
  special_transport: false,
  special_transport_piano: false,
  special_transport_safe: false,
  special_transport_heavy: false,
  additional_info: '',
  how_found: '',
  quotes_wanted: '4',
  datenschutz: false,
  ...
  cleaning_area_size: '',
  cleaning_type: '',
  cleaning_extra_balkon: false,
  cleaning_extra_keller: false,
  cleaning_extra_garage: false,
  what_to_clean: {},
  estimated_area: '',
  floor_types: {},
  floor_area: '',
      ...
      if (prev.umzugArt && prev.umzugArt !== umzugArtValue) {
        if (prev.service === 'reinigung') {
          resetData = {
              ...
              cleaning_area_size: '', cleaning_type: '',
              cleaning_extra_balkon: false, cleaning_extra_keller: false, cleaning_extra_garage: false,
          };
