...
const BaselSidebar = () => {
  ...
  const services = [
    { 
      ...
      url: '/kostenlose-offerte-anfordern?service=umzug&step=2&umzugArt=privatumzug&city=Basel'
    },
    { 
      id: 'geschaeftsumzug',
      name: 'Geschäftsumzug',
      ...
      url: '/kostenlose-offerte-anfordern?service=umzug&step=3&umzugArt=geschaeftsumzug&city=Basel'
    },
    { 
      id: 'international',
      ...
      url: '/kostenlose-offerte-anfordern?service=umzug&step=3&umzugArt=international&city=Basel'
    },
    { 
      id: 'spezialtransport',
      ...
      url: '/kostenlose-offerte-anfordern?service=umzug&step=3&umzugArt=spezialtransport&special_transport_type=klaviertransport&city=Basel'
    },
    { 
      id: 'kleintransport',
      name: 'Kleintransport',
