      ...
      <Card className="shadow-lg rounded-xl border border-gray-200 bg-white">
        <CardContent className="p-6">
          ...
          >
            ...
            <h3 className="text-lg font-bold text-gray-700 mb-1">Noch keine Bewertungen</h3>
            <p className="text-base text-gray-600">Werden Sie der Erste, der eine Bewertung für diesen Partner hinterlässt.</p>
          </motion.div>
        </CardContent>
      </Card>
    );
