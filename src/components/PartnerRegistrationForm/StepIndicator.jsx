  ...
  return (
    <div className="w-full max-w-2xl mx-auto mb-8">
      <div className="flex justify-between items-start relative">
        <div className="absolute top-5 left-0 w-full h-0.5 bg-border transform -translate-y-1/2"></div>
        ...
        {steps.map(s => (
          <div key={s.id} className="z-10 text-center w-1/3">
            <div className={`w-10 h-10 rounded-full flex items-center justify-center text-lg font-bold mx-auto mb-2 transition-colors duration-300 ${currentStep >= s.id ? 'bg-blue-600 text-white' : 'bg-card border-2 border-border text-muted-foreground'}`}>
