...
function showOverlay(element) {
	...
	// Batch all layout reads and writes in requestAnimationFrame to prevent forced reflow
	requestAnimationFrame(() => {
		// Read layout properties in one batch
		const rect = element.getBoundingClientRect();
		
		// Write all style changes in one batch
