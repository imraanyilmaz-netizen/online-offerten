...
export const metadata: Metadata = {
  ...
  keywords: 'Malerfirma Genf, Malerfirma in Genf, Maler Genf, Malerarbeiten Genf, Innenanstrich Genf, Aussenanstrich Genf, Fassadenanstrich Genf, Malerfirma Genf vergleichen, Malerbetrieb Genf',
  alternates: {
    canonical: 'https://online-offerten.ch/malerfirma-genf',
  },
  openGraph: {
    title: 'Malerfirma in Genf finden » Bis zu 40% sparen',
    description: 'Malerfirma in Genf finden ✓ Bis zu 6 kostenlose Offerten von geprüften Malerfirmen in Genf. Innenanstrich, Aussenanstrich – professionell, sicher und bis zu 40% günstiger.',
    url: 'https://online-offerten.ch/malerfirma-genf',
    siteName: 'Online-Offerten.ch',
    images: [
      {
        url: 'https://online-offerten.ch/image/malerfirma-genf-finden.png',
        width: 1200,
        height: 630,
        alt: 'Malerfirma in Genf finden',
      },
    ],
    locale: 'de_CH',
    type: 'website',
  ...
  twitter: {
    ...
    title: 'Malerfirma in Genf finden » Bis zu 40% sparen',
    description: 'Malerfirma in Genf finden ✓ Bis zu 6 kostenlose Offerten von geprüften Malerfirmen in Genf.',
    images: ['https://online-offerten.ch/image/malerfirma-genf-finden.png'],
  },
  robots: {
    index: true,
    follow: true,
