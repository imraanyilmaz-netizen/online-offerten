...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Reinigungsfirma in der Nähe finden ✓ Bis zu 6 kostenlose Offerten von geprüften Reinigungsfirmen in Ihrer Region. Büroreinigung, Haushaltsreinigung – professionell, sicher und bis zu 40% günstiger.',
  ...
  twitter: {
    ...
    title: 'Reinigungsfirma in der Nähe finden » Bis zu 40% sparen',
    description: 'Reinigungsfirma in der Nähe finden ✓ Bis zu 6 kostenlose Offerten von geprüften Reinigungsfirmen in Ihrer Region.',
