...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://online-offerten.ch/reinigungsfirma-in-der-naehe/genf',
  },
  openGraph: {
    title: 'Reinigungsfirma Genf finden » Bis zu 40% sparen',
    description: 'Reinigungsfirma Genf finden ✓ Bis zu 6 kostenlose Offerten von geprüften Reinigungsfirmen in Genf. Büroreinigung, Haushaltsreinigung – professionell, sicher und bis zu 40% günstiger.',
    url: 'https://online-offerten.ch/reinigungsfirma-in-der-naehe/genf',
  ...
  twitter: {
    ...
    title: 'Reinigungsfirma Genf finden » Bis zu 40% sparen',
    description: 'Reinigungsfirma Genf finden ✓ Bis zu 6 kostenlose Offerten von geprüften Reinigungsfirmen in Genf.',
...
const stadtInfo = {
  name: 'Genf',
  slug: 'genf',
  canonicalUrl: 'https://online-offerten.ch/reinigungsfirma-in-der-naehe/genf',
  description: 'Finden Sie die besten Reinigungsunternehmen in Genf. Vergleichen Sie bis zu 6 kostenlose Offerten von geprüften Reinigungsanbietern in Genf.',
}
