...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://online-offerten.ch/reinigungsfirma-in-der-naehe/zuerich',
  },
  openGraph: {
    title: 'Reinigungsfirma Zürich finden » Bis zu 40% sparen',
    description: 'Reinigungsfirma Zürich finden ✓ Bis zu 6 kostenlose Offerten von geprüften Reinigungsfirmen in Zürich. Büroreinigung, Haushaltsreinigung – professionell, sicher und bis zu 40% günstiger.',
    url: 'https://online-offerten.ch/reinigungsfirma-in-der-naehe/zuerich',
  ...
  twitter: {
    ...
    title: 'Reinigungsfirma Zürich finden » Bis zu 40% sparen',
    description: 'Reinigungsfirma Zürich finden ✓ Bis zu 6 kostenlose Offerten von geprüften Reinigungsfirmen in Zürich.',
...
const stadtInfo = {
  name: 'Zürich',
  slug: 'zuerich',
  canonicalUrl: 'https://online-offerten.ch/reinigungsfirma-in-der-naehe/zuerich',
  description: 'Finden Sie die besten Reinigungsunternehmen in Zürich. Vergleichen Sie bis zu 6 kostenlose Offerten von geprüften Reinigungsanbietern in Zürich.',
}
