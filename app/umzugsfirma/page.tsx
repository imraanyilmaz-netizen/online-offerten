...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Umzugsfirma finden und vergleichen ✓ Bis zu 6 kostenlose Offerten von geprüften Umzugsfirmen in der Schweiz. Privatumzug, Geschäftsumzug – schnell, sicher und bis zu 40% günstiger.',
  ...
  twitter: {
    ...
    title: 'Umzugsfirma finden & vergleichen » Bis zu 40% sparen',
    description: 'Umzugsfirma finden und vergleichen ✓ Bis zu 6 kostenlose Offerten von geprüften Umzugsfirmen in der Schweiz.',
