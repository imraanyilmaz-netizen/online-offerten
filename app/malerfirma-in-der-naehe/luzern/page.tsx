...
const city = "Luzern"
const canonicalUrl = '/malerfirma-in-der-naehe/luzern'

const luzernFAQs = [
  {
    question: "Wie finde ich eine zuverlässige Malerfirma in Luzern?",
    answer: "Vergleichen Sie mehrere Offerten von geprüften Malerfirmen. Achten Sie auf lokale Erfahrung, besonders mit Malerarbeiten in den verschiedenen Stadtteilen von Luzern. Seriöse Firmen kennen die Bauvorschriften und haben Erfahrung mit den typischen Herausforderungen Luzerner Gebäude."
  },
  {
...
export const metadata: Metadata = {
  title: 'Malerfirma Luzern – Top Anbieter vergleichen & sparen',
  description: 'Malerfirma Luzern finden ✓ Geprüfte Malerbetriebe vergleichen & bis zu 40% sparen. Kostenlose Offerten für Innenanstrich, Aussenanstrich & Fassadenanstrich.',
  alternates: {
    canonical: `https://online-offerten.ch${canonicalUrl}`,
  },
  openGraph: {
    title: 'Malerfirma Luzern » Top Malerbetriebe vergleichen & sparen',
    description: 'Malerfirma Luzern finden ✓ Geprüfte Malerbetriebe vergleichen & bis zu 40% sparen.',
