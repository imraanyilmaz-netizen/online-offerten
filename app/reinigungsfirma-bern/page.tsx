...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Reinigungsfirma Bern finden ✓ Bis zu 6 kostenlose Offerten von geprüften Reinigungsfirmen in Bern. Büroreinigung, Haushaltsreinigung – professionell, sicher und bis zu 40% günstiger.',
    url: 'https://online-offerten.ch/reinigungsfirma-bern',
  ...
  twitter: {
    ...
    title: 'Reinigungsfirma Bern finden » Bis zu 40% sparen',
    description: 'Reinigungsfirma Bern finden ✓ Bis zu 6 kostenlose Offerten von geprüften Reinigungsfirmen in Bern.',
...
const stadtInfo = {
  name: 'Bern',
  slug: 'bern',
  canonicalUrl: 'https://online-offerten.ch/reinigungsfirma-bern',
  description: 'Finden Sie die besten Reinigungsunternehmen in Bern. Vergleichen Sie bis zu 6 kostenlose Offerten von geprüften Reinigungsanbietern in Bern.',
}
