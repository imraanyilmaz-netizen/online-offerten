...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Reinigungsfirma Lausanne finden ✓ Bis zu 6 kostenlose Offerten von geprüften Reinigungsfirmen in Lausanne. Büroreinigung, Haushaltsreinigung – professionell, sicher und bis zu 40% günstiger.',
    url: 'https://online-offerten.ch/reinigungsfirma-lausanne',
  ...
  twitter: {
    ...
    title: 'Reinigungsfirma Lausanne finden » Bis zu 40% sparen',
    description: 'Reinigungsfirma Lausanne finden ✓ Bis zu 6 kostenlose Offerten von geprüften Reinigungsfirmen in Lausanne.',
...
const stadtInfo = {
  name: 'Lausanne',
  slug: 'lausanne',
  canonicalUrl: 'https://online-offerten.ch/reinigungsfirma-lausanne',
  description: 'Finden Sie die besten Reinigungsunternehmen in Lausanne. Vergleichen Sie bis zu 6 kostenlose Offerten von geprüften Reinigungsanbietern in Lausanne.',
}
