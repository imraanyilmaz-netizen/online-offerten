...
export const metadata: Metadata = {
  title: 'Endreinigung Wohnung Kosten 2024: Ultimative Preis-Übersicht + 10 Spartipps',
  description: 'Endreinigung Wohnung Kosten 2024: Der komplette Schweizer Kostenguide für stressfreie Wohnungsübergabe. Detaillierte Preistabellen, regionale Unterschiede und 10 bewährte Spartipps die wirklich funktionieren. Bis zu 30% sparen durch Preisvergleich.',
  alternates: {
