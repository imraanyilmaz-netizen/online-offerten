...
export const metadata: Metadata = {
  ...
  description: 'Umzugsofferten Zürich kostenlos vergleichen ✓ In wenigen Minuten zur passenden Zügelfirma. Bis zu 6 geprüfte Offerten von Umzugsfirmen in Zürich. Jetzt kostenlos anfordern!',
  alternates: {
    canonical: 'https://online-offerten.ch/umzugsfirma-in-der-naehe/zuerich/umzugsofferten-zuerich',
  },
  openGraph: {
    title: 'Umzugsofferten Zürich – kostenlos vergleichen & passende Zügelfirma finden',
    description: 'Umzugsofferten Zürich kostenlos vergleichen ✓ In wenigen Minuten zur passenden Zügelfirma. Bis zu 6 geprüfte Offerten von Umzugsfirmen in Zürich.',
    url: 'https://online-offerten.ch/umzugsfirma-in-der-naehe/zuerich/umzugsofferten-zuerich',
