...
const MalerfirmaLausannePageClient = () => {
  ...
  const city = 'Lausanne'
  const canonicalUrl = 'https://online-offerten.ch/malerfirma-in-der-naehe/lausanne'
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 my-8">
                ...
                <div className="space-y-4 text-gray-700">
                  <div className="border-l-4 border-purple-600 pl-4">
                    ...
                    <p><strong>Beispiel:</strong> Eine 3.5-Zimmer-Wohnung (95 mÂ²) in Lausanne kostet für einen Innenanstrich durchschnittlich <strong>CHF 1.350–3.100</strong>. Eine 4-Zimmer-Wohnung (120 mÂ²) kostet <strong>CHF 1.750–4.000</strong>.</p>
                  </div>
                  <div className="border-l-4 border-purple-600 pl-4">
                    <p className="font-semibold text-gray-900 mb-1">Fassadenanstrich</p>
                    <p><strong>Beispiel:</strong> Ein Einfamilienhaus (200 mÂ² Fassadenfläche) in Lausanne kostet für einen Fassadenanstrich durchschnittlich <strong>CHF 5.800–15.500</strong>. Die Preise variieren je nach Gebäudetyp und Zugänglichkeit.</p>
                  </div>
                  <div className="border-l-4 border-purple-600 pl-4">
                    <p className="font-semibold text-gray-900 mb-1">Aussenanstrich</p>
                    <p><strong>Beispiel:</strong> Eine Wohnung (80 mÂ² Aussenfläche) in Lausanne kostet für einen Aussenanstrich durchschnittlich <strong>CHF 2.300–6.200</strong>. Besonders bei Gebäuden in Seelage können zusätzliche Vorarbeiten anfallen.</p>
                  </div>
