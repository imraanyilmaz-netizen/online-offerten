          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: `Erhalten Sie bis zu 6 Offerten von lokalen Malerbetrieben in $Lausanne. Die Anbieter nehmen direkt Kontakt mit Ihnen auf und erstellen individuelle Offerten.`,
                icon: Mail
              },
              {
                number: "03",
              ...
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="item-1">
                  <AccordionTrigger className="text-left">
                    Was kostet eine Malerfirma in Lausanne?
                  </AccordionTrigger>
                ...
                <AccordionItem value="item-3">
                  <AccordionTrigger className="text-left">
                    Sind die Malerfirmen in Lausanne versichert?
                  </AccordionTrigger>
                  <AccordionContent className="text-gray-700">
        ...
        <div className="container mx-auto max-w-7xl px-4 md:px-6">
          ...
          >
            ...
            <p className="text-xl mb-8 text-purple-50">
              Fordern Sie jetzt kostenlos und unverbindlich bis zu 6 Offerten von geprüften Maleranbietern in Lausanne an. Vergleichen Sie Preise und sparen Sie bis zu 40% bei Ihren Malerarbeiten.
            </p>
