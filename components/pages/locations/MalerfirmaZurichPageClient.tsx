              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 my-8">
                ...
                <div className="space-y-4 text-gray-700">
                  <div className="border-l-4 border-purple-600 pl-4">
                    ...
                    <p><strong>Beispiel:</strong> Eine 3.5-Zimmer-Wohnung (95 mÂ²) in Zürich kostet für einen Innenanstrich durchschnittlich <strong>CHF 1.400–3.300</strong>. Eine 4-Zimmer-Wohnung (120 mÂ²) kostet <strong>CHF 1.800–4.200</strong>.</p>
                  </div>
                  <div className="border-l-4 border-purple-600 pl-4">
                    <p className="font-semibold text-gray-900 mb-1">Fassadenanstrich</p>
                    <p><strong>Beispiel:</strong> Ein Einfamilienhaus (200 mÂ² Fassadenfläche) in Zürich kostet für einen Fassadenanstrich durchschnittlich <strong>CHF 6.000–16.000</strong>. Die Preise variieren je nach Gebäudetyp und Zugänglichkeit.</p>
                  </div>
                  <div className="border-l-4 border-purple-600 pl-4">
                    <p className="font-semibold text-gray-900 mb-1">Aussenanstrich</p>
                    <p><strong>Beispiel:</strong> Eine Wohnung (80 mÂ² Aussenfläche) in Zürich kostet für einen Aussenanstrich durchschnittlich <strong>CHF 2.400–6.400</strong>. Besonders bei Altbauten können zusätzliche Vorarbeiten anfallen.</p>
                  </div>
