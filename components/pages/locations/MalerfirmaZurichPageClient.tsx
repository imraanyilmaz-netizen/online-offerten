...
const MalerfirmaZurichPageClient = () => {
  ...
  const city = 'Zürich'
  const canonicalUrl = 'https://online-offerten.ch/malerfirma-zuerich'
        ...
        <div className="container mx-auto max-w-navbar px-4 md:px-6">
          ...
          >
            ...
            <p className="text-xl mb-8 text-purple-50">
              Fordern Sie jetzt kostenlos und unverbindlich bis zu 6 Offerten von geprüften Maleranbietern in Zürich an. Vergleichen Sie Preise und sparen Sie bis zu 40% bei Ihren Malerarbeiten.
            </p>
