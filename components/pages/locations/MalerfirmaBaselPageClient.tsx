...
import { 
  ...
  FileText, Search, HeartHandshake, Zap, Layers, Navigation2, Route, Mail, Globe
} from 'lucide-react'
...
const MalerfirmaBaselPageClient = () => {
  ...
  const services = [
    {
      title: "Innenanstrich",
      description: "Professioneller Innenanstrich für Ihre Wohnung oder Ihr Haus in Basel. Von den historischen Altbauwohnungen in der Altstadt bis zu modernen Neubauten – lokale Malerbetriebe kennen die regionalen Besonderheiten.",
      icon: Home
    },
    {
      title: "Aussenanstrich",
      description: "Wetterfester Aussenanstrich für Fassaden, Balkone und Aussenbereiche in Basel. Lokale Malerfirmen kennen die örtlichen Wetterbedingungen und die spezifischen Anforderungen der Dreiländerregion.",
      icon: Building
    },
    {
      title: "Fassadenanstrich",
      description: "Professionelle Fassadenrenovation und -anstrich in Basel. Wir geben Ihrem Gebäude ein neues, gepflegtes Erscheinungsbild – von denkmalgeschützten Altbauten bis zu modernen Gebäuden.",
      icon: Layers
    }
  ]
  ...
  const localAdvantages = [
    {
      icon: Globe,
      title: "Dreiländerregion Basel",
      description: "Malerfirmen in Basel kennen die spezifischen Anforderungen der Dreiländerregion. Sie haben Erfahrung mit verschiedenen Baustilen und Materialien aus der Schweiz, Deutschland und Frankreich."
    },
    {
      icon: ShieldCheck,
      title: "Kenntnisse historischer Bausubstanz",
      description: "Basel verfügt über eine reiche historische Bausubstanz. Lokale Malerbetriebe kennen die Denkmalschutzbestimmungen und haben Erfahrung mit der Renovation historischer Gebäude."
    },
    {
      icon: Clock,
      title: "Schnelle Reaktionszeiten",
      description: "Bei Notfällen oder kurzfristigen Änderungen können regionale Malerunternehmen in Basel schneller reagieren. Die kompakte Stadtstruktur ermöglicht kurze Anfahrtswege."
    },
    {
      icon: Building,
      title: "Erfahrung mit verschiedenen Gebäudetypen",
      description: "Basel bietet eine Mischung aus historischen Altbauten, modernen Neubauten und Gewerbeimmobilien. Lokale Malerbetriebe haben Erfahrung mit allen Gebäudetypen."
    }
  ]
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-gray-700 mb-8 leading-relaxed">
                In Basel, der Kulturhauptstadt am Dreiländereck, sind professionelle Malerarbeiten besonders gefragt – von den historischen Altbauwohnungen in der malerischen Altstadt bis zu modernen Neubauten. Lokale <strong>Malerbetriebe in Basel</strong> kennen die regionalen Bauvorschriften, Denkmalschutzbestimmungen und die spezifischen Anforderungen der Dreiländerregion. Vergleichen Sie <strong>bis zu 6 kostenlose Offerten</strong> von geprüften <strong>Maleranbietern in Basel</strong> – <strong>100% kostenlos und unverbindlich</strong>.
              </p>
            ...
            >
              <div className="bg-white rounded-2xl p-8 shadow-2xl border-4 border-purple-200">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4 text-center">
                  Finden Sie Ihre Malerfirma in Basel
                </h3>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <div className="text-gray-700 leading-relaxed space-y-4">
                <p className="text-lg">
                  Basel ist die Kulturhauptstadt am Dreiländereck und bietet eine einzigartige Mischung aus historischen Altbauten und modernen Neubauten. Lokale <strong>Malerbetriebe in Basel</strong> kennen die spezifischen Herausforderungen der Stadt: von den engen Gassen der historischen Altstadt bis zu den modernen Gebäuden in den neuen Stadtteilen.
                </p>
                <p>
                  Eine <strong>Malerfirma in Basel</strong> zu wählen, bietet zahlreiche Vorteile. Regionale <strong>Malerbetriebe</strong> kennen die örtlichen Bauvorschriften, Denkmalschutzbestimmungen und die spezifischen Anforderungen der Dreiländerregion. Sie haben Erfahrung mit den unterschiedlichen Gebäudetypen in Basel – von denkmalgeschützten Altbauten bis zu modernen Neubauten.
                </p>
                <p>
                  Lokale <strong>Maleranbieter in Basel</strong> haben kürzere Anfahrtswege, was die Kosten reduziert und die Umweltbelastung minimiert. Die kompakte Stadtstruktur von Basel ermöglicht kurze Anfahrtszeiten. Regionale <strong>Malerunternehmen</strong> können schneller auf Notfälle oder kurzfristige Änderungen reagieren und bieten flexiblere Terminplanung.
                </p>
                <p>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 my-8">
                ...
                <div className="space-y-4 text-gray-700">
                  <div className="border-l-4 border-purple-600 pl-4">
                    ...
                    <p><strong>Beispiel:</strong> Eine 3.5-Zimmer-Wohnung (95 m²) in Basel kostet für einen Innenanstrich durchschnittlich <strong>CHF 1.300–3.000</strong>. Eine 4-Zimmer-Wohnung (120 m²) kostet <strong>CHF 1.700–3.900</strong>.</p>
                  </div>
                  <div className="border-l-4 border-purple-600 pl-4">
                    <p className="font-semibold text-gray-900 mb-1">Fassadenanstrich</p>
                    <p><strong>Beispiel:</strong> Ein Einfamilienhaus (200 m² Fassadenfläche) in Basel kostet für einen Fassadenanstrich durchschnittlich <strong>CHF 5.500–15.000</strong>. Die Preise variieren je nach Gebäudetyp und Zugänglichkeit.</p>
                  </div>
                  <div className="border-l-4 border-purple-600 pl-4">
                    <p className="font-semibold text-gray-900 mb-1">Aussenanstrich</p>
                    <p><strong>Beispiel:</strong> Eine Wohnung (80 m² Aussenfläche) in Basel kostet für einen Aussenanstrich durchschnittlich <strong>CHF 2.200–6.000</strong>. Besonders bei historischen Altbauten können zusätzliche Vorarbeiten anfallen.</p>
                  </div>
                  <div className="mt-4 pt-4 border-t border-gray-300">
                    <p className="text-sm text-gray-600 italic">
                      <strong>Hinweis:</strong> Diese Preise sind Richtwerte für Basel und können je nach Anbieter, Maleraufwand, Materialqualität, Termin und Stadtteil variieren. Durch den Vergleich mehrerer Offerten von lokalen Malerbetrieben in Basel können Sie bis zu 40% sparen.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: `Vergleichen Sie Preise, Leistungen und Bewertungen. Wählen Sie den besten Maleranbieter in Basel für Ihre Malerarbeiten aus.`,
                icon: Star
              }
            ].map((step, index) => (
              <motion.div
        ...
        <div className="container mx-auto max-w-navbar px-4 md:px-6">
          ...
          >
            ...
            <p className="text-xl mb-8 text-purple-50">
              Fordern Sie jetzt kostenlos und unverbindlich bis zu 6 Offerten von geprüften Maleranbietern in Basel an. Vergleichen Sie Preise und sparen Sie bis zu 40% bei Ihren Malerarbeiten.
            </p>
...
export default MalerfirmaBaselPageClient
