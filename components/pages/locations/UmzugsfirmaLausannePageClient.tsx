        ...
        <div className="container mx-auto max-w-7xl px-4 md:px-6">
          ...
          <nav className="mb-4 pt-4" aria-label="Breadcrumb">
            <ol className="flex items-center space-x-2 text-sm text-gray-600">
              ...
              <li><ChevronRight className="w-4 h-4 text-gray-400" /></li>
              <li className="text-gray-900 font-medium" aria-current="page">Umzugsfirma Lausanne</li>
            </ol>
          </nav>

          <header className="text-center mb-12 md:mb-16 pt-8">
          ...
          <div className="grid lg:grid-cols-5 gap-8 md:gap-12 items-start">
            <main className="lg:col-span-3 bg-white p-6 md:p-8 rounded-xl shadow-xl space-y-8">
              <article>
                <h2 className="heading-2">Stressfreier Umzug in der malerischen Stadt Lausanne</h2>
