...
const UmzugsfirmaLuganoPageClient = () => {
  ...
  const hourlyRates = [
    { service: "1 Umzugswagen + 1 Zügelmann", price: "CHF 108.-" },
    { service: "1 Umzugswagen + 2 Zügelmänner", price: "CHF 168.-" },
    { service: "1 Umzugswagen + 3 Zügelmänner", price: "CHF 208.-" },
    { service: "2 Umzugswagen + 4 Zügelmänner", price: "CHF 268.-" },
    { service: "2 Umzugswagen + 5 Zügelmänner", price: "CHF 320.-" },
    { service: "2 Umzugswagen + 6 Zügelmänner", price: "CHF 388.-" }
  ];

  // Cost table data - By room size
  const costTableRows = [
    { size: "1.5-Zimmer-Wohnung", cost: "CHF 610 - 650" },
    { size: "2.5-Zimmer-Wohnung", cost: "CHF 650 - 970" },
    { size: "3.5-Zimmer-Wohnung", cost: "CHF 1'070 - 1'240" },
    { size: "4.5-Zimmer-Wohnung", cost: "CHF 1'410 - 1'880" },
    { size: "5.5-Zimmer-Wohnung", cost: "CHF 1'970 - 2'480" },
    { size: "6.5-Zimmer-Wohnung", cost: "CHF 2'480 - 3'140" }
  ];
        ...
        <div className="container mx-auto max-w-7xl px-4 md:px-6">
          ...
          <nav className="mb-4 pt-4" aria-label="Breadcrumb">
            <ol className="flex items-center space-x-2 text-sm text-gray-600">
              ...
              <li><ChevronRight className="w-4 h-4 text-gray-400" /></li>
              <li className="text-gray-900 font-medium" aria-current="page">Umzugsfirma Lugano</li>
            </ol>
          </nav>
          ...
          >
            <h1 className="heading-1">
              Umzugsfirma Lugano – Umzugsangebote im Tessin vergleichen
            </h1>
          ...
          <div className="grid lg:grid-cols-5 gap-8 md:gap-12 items-start">
            ...
            >
              <article>
                <h2 className="heading-2">Umziehen in Lugano: Einfachheit und Stil</h2>
              ...
              <article className="pt-8 border-t border-gray-200 space-y-6">
                <h2 className="heading-2 mb-6">Was kostet ein Umzug mit einer Umzugsfirma in Lugano?</h2>
                <p className="text-body mb-4">
                  Die Umzugskosten für einen Umzug mit einer professionellen Umzugsfirma in Lugano richten sich nach dem individuellen Aufwand. Massgeblich sind dabei Faktoren wie die Distanz zwischen Start- und Zieladresse, die Anzahl der Stockwerke, die Verfügbarkeit eines Lifts, das Umzugsvolumen sowie gewünschte Zusatzleistungen.
                </p>
                <p className="text-body mb-6">
                  Die angegebenen Richtwerte beziehen sich auf Umzüge ab oder innerhalb von Lugano und dienen ausschliesslich zur Orientierung. Preisunterschiede können je nach Wohnsituation, Zugänglichkeit der Liegenschaft und Umfang des Umzugsguts entstehen.
                </p>
