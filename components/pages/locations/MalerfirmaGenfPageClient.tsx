...
import { 
  ...
  FileText, Search, HeartHandshake, Zap, Layers, Navigation2, Route, Mail, Globe, HelpCircle
} from 'lucide-react'
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from '@/components/ui/accordion'

const MalerfirmaGenfPageClient = () => {
  const router = useRouter()
  const city = 'Genf'
  const canonicalUrl = 'https://online-offerten.ch/malerfirma-genf'
  ...
  useEffect(() => {
    ...
    script.id = 'malerfirma-genf-schema'
    
    const existing = document.getElementById('malerfirma-genf-schema')
    if (existing) existing.remove()
    
    document.head.appendChild(script)
    
    return () => {
      const scriptToRemove = document.getElementById('malerfirma-genf-schema')
  ...
  const services = [
    {
      title: "Innenanstrich",
      description: "Professioneller Innenanstrich für Ihre Wohnung oder Ihr Haus in Genf. Von den eleganten Altbauwohnungen bis zu modernen Neubauten – lokale Malerbetriebe kennen die regionalen Besonderheiten der internationalen Stadt.",
      icon: Home
    },
    {
      title: "Aussenanstrich",
      description: "Wetterfester Aussenanstrich für Fassaden, Balkone und Aussenbereiche in Genf. Lokale Malerfirmen kennen die örtlichen Wetterbedingungen und die spezifischen Anforderungen der französischsprachigen Region.",
      icon: Building
    },
    {
      title: "Fassadenanstrich",
      description: "Professionelle Fassadenrenovation und -anstrich in Genf. Wir geben Ihrem Gebäude ein neues, gepflegtes Erscheinungsbild – von historischen Altbauten bis zu modernen Gebäuden.",
      icon: Layers
    }
  ]
  ...
  const localAdvantages = [
    {
      icon: Globe,
      title: "Internationale Stadt Genf",
      description: "Malerbetriebe in Genf kennen die spezifischen Anforderungen der internationalen Stadt. Sie haben Erfahrung mit verschiedenen Baustilen und Materialien und arbeiten oft mit internationalen Kunden."
    },
    {
      icon: ShieldCheck,
      title: "Französischsprachige Region",
      description: "Genf liegt in der französischsprachigen Region der Schweiz. Lokale Malerbetriebe kommunizieren auf Französisch und kennen die spezifischen Bauvorschriften und Standards der Region."
    },
    {
      icon: Clock,
      title: "Schnelle Reaktionszeiten",
      description: "Bei Notfällen oder kurzfristigen Änderungen können regionale Malerfirmen in Genf schneller reagieren. Die kompakte Stadtstruktur ermöglicht kurze Anfahrtswege."
    },
    {
      icon: Building,
      title: "Erfahrung mit verschiedenen Gebäudetypen",
      description: "Genf bietet eine Mischung aus historischen Altbauten, modernen Neubauten und internationalen Gebäuden. Lokale Malerbetriebe haben Erfahrung mit allen Gebäudetypen."
    }
  ]
    ...
    <>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-gray-900 mb-6 leading-tight">
                Malerfirma in Genf finden & vergleichen – Bis zu 40% sparen
              </h1>
              <p className="text-2xl md:text-3xl text-gray-700 font-bold mb-4">
                Lokale Malerbetriebe in Genf vergleichen
              </p>
              <p className="text-lg md:text-xl text-gray-700 mb-8 leading-relaxed">
                In Genf, der internationalen Stadt am Genfersee, sind professionelle Malerarbeiten besonders gefragt – von den eleganten Altbauwohnungen bis zu modernen Neubauten. Lokale <strong>Malerbetriebe in Genf</strong> kennen die regionalen Bauvorschriften, die spezifischen Anforderungen der französischsprachigen Region und arbeiten oft mit internationalen Kunden. Vergleichen Sie <strong>bis zu 6 kostenlose Offerten</strong> von geprüften <strong>Maleranbietern in Genf</strong> – <strong>100% kostenlos und unverbindlich</strong>.
              </p>
            ...
            >
              <div className="bg-white rounded-2xl p-8 shadow-2xl border-4 border-purple-200">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4 text-center">
                  Finden Sie Ihre Malerfirma in Genf
                </h3>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                Warum eine Malerfirma in Genf wählen?
              </h2>
              <div className="text-gray-700 leading-relaxed space-y-4">
                <p className="text-lg">
                  Genf ist eine internationale Stadt am Genfersee und bietet eine einzigartige Mischung aus historischen Altbauten und modernen Neubauten. Lokale <strong>Malerbetriebe in Genf</strong> kennen die spezifischen Herausforderungen der Stadt: von den eleganten Altbauwohnungen bis zu den modernen Gebäuden in den neuen Stadtteilen.
                </p>
                <p>
                  Eine <strong>Malerfirma in Genf</strong> zu wählen, bietet zahlreiche Vorteile. Regionale <strong>Malerbetriebe</strong> kennen die örtlichen Bauvorschriften, die spezifischen Anforderungen der französischsprachigen Region und arbeiten oft mit internationalen Kunden. Sie haben Erfahrung mit den unterschiedlichen Gebäudetypen in Genf – von historischen Altbauten bis zu modernen Neubauten.
                </p>
                <p>
                  Lokale <strong>Maleranbieter in Genf</strong> haben kürzere Anfahrtswege, was die Kosten reduziert und die Umweltbelastung minimiert. Die kompakte Stadtstruktur von Genf ermöglicht kurze Anfahrtszeiten. Regionale <strong>Malerunternehmen</strong> können schneller auf Notfälle oder kurzfristige Änderungen reagieren und bieten flexiblere Terminplanung.
                </p>
                <p>
                  In Genf spielen internationale Bauprojekte, Altbauten und mehrsprachige Kommunikation eine wichtige Rolle bei Malerarbeiten. Viele lokale Malerbetriebe haben spezielle Erfahrung mit der Renovation historischer Gebäude und modernen internationalen Projekten.
                </p>
              </div>
            </motion.div>
          </div>
        ...
        <div className="container mx-auto max-w-navbar px-4 md:px-6">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Welche Malerarbeiten benötigen Sie in Genf?
            </h2>
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              Verschiedene Malerbetriebe in Genf spezialisieren sich auf unterschiedliche Arten von Malerarbeiten. Finden Sie den richtigen Fachbetrieb für Ihren spezifischen Bedarf.
            </p>
          </motion.div>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto max-w-navbar px-4 md:px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              Regionale Malerbetriebe in Genf bieten zahlreiche Vorteile, die oft übersehen werden.
            </p>
          </motion.div>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto max-w-navbar px-4 md:px-6">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              So finden Sie eine Malerfirma in Genf
            </h2>
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: `Erhalten Sie bis zu 6 Offerten von lokalen Malerbetrieben in Genf. Die Anbieter nehmen direkt Kontakt mit Ihnen auf und erstellen individuelle Offerten.`,
                icon: Mail
              },
              {
                number: "03",
        ...
        <div className="container mx-auto max-w-navbar px-4 md:px-6">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Bereit, Malerbetriebe in Genf zu finden?
            </h2>
            <p className="text-xl mb-8 text-purple-50">
              Fordern Sie jetzt kostenlos und unverbindlich bis zu 6 Offerten von geprüften Maleranbietern in {city} an. Vergleichen Sie Preise und sparen Sie bis zu 40% bei Ihren Malerarbeiten.
            </p>
