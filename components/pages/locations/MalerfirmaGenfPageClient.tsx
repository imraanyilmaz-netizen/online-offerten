          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: `Erhalten Sie bis zu 5 Offerten von lokalen Malerbetrieben in Genf. Die Anbieter nehmen direkt Kontakt mit Ihnen auf und erstellen individuelle Offerten.`,
                icon: Mail
              },
              {
                number: "03",
        ...
        <div className="container mx-auto max-w-7xl px-4 md:px-6">
          ...
          >
            ...
            <p className="text-xl mb-8 text-purple-50">
              Fordern Sie jetzt kostenlos und unverbindlich bis zu 5 Offerten von geprüften Maleranbietern in {city} an. Vergleichen Sie Preise und sparen Sie bis zu 40% bei Ihren Malerarbeiten.
            </p>
