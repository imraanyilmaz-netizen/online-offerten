...
const MalerfirmaPageClient = () => {
    ...
    const schemaData = {
      ...
      "@graph": [
        ...
        },
        {
          ...
          "description": "Finden Sie den besten Fachbetrieb für Malerarbeiten in der Schweiz. Vergleichen Sie bis zu 6 kostenlose Offerten von geprüften Malerbetrieben für Innenanstrich, Aussenanstrich, Fassadenanstrich und mehr.",
          "provider": {
            "@type": "Organization",
        ...
        },
        {
          ...
          "mainEntity": [
            ...
            },
            {
              ...
              "acceptedAnswer": {
                "@type": "Answer",
                "text": "Sie erhalten bis zu 6 kostenlose und unverbindliche Offerten von qualitätsgeprüften Malerfirmen aus Ihrer Region. Nachdem Sie das Formular ausgefüllt haben, nehmen die Malerfirmen direkt Kontakt mit Ihnen auf (per Telefon oder E-Mail) und erstellen Ihnen eine individuelle Offerte. So haben Sie die perfekte Vergleichsgrundlage, um die beste Malerfirma für Ihren Bedarf zu finden."
              }
            },
            {
              "@type": "Question",
        ...
        },
        {
          ...
          "step": [
            ...
            },
            {
              ...
              "text": "Fordern Sie über Online-Offerten.ch bis zu 6 kostenlose Offerten von geprüften Malerfirmen in Ihrer Region an."
            },
            {
              "@type": "HowToStep",
              "position": 3,
  ...
  const features = [
    {
      icon: CheckCircle,
      title: 'Bis zu 6 Malerfirmen vergleichen',
  ...
  const faqItems = [
    ...
    },
    {
      ...
      a: "Sie erhalten bis zu 6 kostenlose und unverbindliche Offerten von qualitätsgeprüften Malerbetrieben aus Ihrer Region. Nachdem Sie das Formular ausgefüllt haben, nehmen die Anbieter direkt Kontakt mit Ihnen auf (per Telefon oder E-Mail) und erstellen Ihnen eine individuelle Offerte mit allen wichtigen Details wie Preis, enthaltene Leistungen, verwendete Materialien und Kontaktinformationen. So haben Sie die perfekte Vergleichsgrundlage, um den besten Fachbetrieb für Ihren Bedarf zu finden. In Ballungsgebieten wie Zürich, Basel oder Bern erhalten Sie meist alle 6 Offerten, in ländlicheren Regionen können es auch 3-4 Offerten sein."
    },
    {
        ...
        <div className="container mx-auto max-w-navbar px-4 md:px-6">
          ...
          >
            ...
            <p className="text-xl mb-8 text-blue-50">
              Fordern Sie jetzt kostenlos und unverbindlich bis zu 6 Offerten von geprüften Malerfirmen an. Vergleichen Sie Preise und sparen Sie bis zu 40% bei Ihren Malerarbeiten.
            </p>
