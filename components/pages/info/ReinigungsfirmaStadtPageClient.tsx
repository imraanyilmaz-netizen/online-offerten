...
const ReinigungsfirmaStadtPageClient = ({ stadtInfo }: ReinigungsfirmaStadtPageClientProps) => {
    ...
    const schemaData = {
      ...
      "@graph": [
        ...
        },
        {
          ...
          "description": `Finden Sie die besten Reinigungsunternehmen in ${name}. Vergleichen Sie bis zu 6 kostenlose Offerten von geprüften Reinigungsanbietern in ${name} für Büroreinigung, Haushaltsreinigung und mehr.`,
          "provider": {
            "@type": "Organization",
  ...
  const faqItems = [
    ...
    },
    {
      ...
      a: `Sie erhalten bis zu 6 kostenlose und unverbindliche Offerten von qualitätsgeprüften Reinigungsanbietern aus ${name}. Nachdem Sie das Formular ausgefüllt haben, nehmen die Reinigungsunternehmen in ${name} direkt Kontakt mit Ihnen auf (per Telefon oder E-Mail) und erstellen Ihnen eine individuelle Offerte. In ${name} erhalten Sie meist alle 6 Offerten, da es eine grosse Auswahl an Reinigungsanbietern gibt. Jede Offerte wird individuell auf Ihre Bedürfnisse zugeschnitten.`
    },
    {
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: `Erhalten Sie bis zu 6 Offerten von Reinigungsunternehmen in ${name}. Die Anbieter nehmen direkt Kontakt mit Ihnen auf und erstellen individuelle Offerten.`,
                icon: Mail
              },
              {
                number: "03",
