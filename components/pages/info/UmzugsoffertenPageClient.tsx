...
const UmzugsoffertenPageClient: React.FC<UmzugsoffertenPageClientProps> = ({ initialReviewStats }) => {
  ...
  const canonicalUrl = 'https://online-offerten.ch/umzugsfirma/umzugsofferten'
    ...
    const fetchReviewStats = async () => {
      try {
        ...
        if (initialReviewStats) {
          setRatingStats({
            reviewCount: initialReviewStats.reviewCount,
            averageRating: initialReviewStats.averageRating
          })
        }
      }
    }

    // Only fetch if initialReviewStats not provided or if we want to update
    if (!initialReviewStats || initialReviewStats.reviewCount === 0) {
      fetchReviewStats()
    }
  }, [initialReviewStats])
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="container mx-auto max-w-7xl px-4 md:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <h2 id="umzugsofferte-3-schritte" className="typography-h2 mb-6 scroll-mt-24">
            ...
            <h2 id="umzugsofferte-vergleich" className="typography-h2 mb-4 mt-8 scroll-mt-24">
            ...
            <p className="typography-p mb-4">
              Auf Online-Offerten.ch erhalten Sie mit nur einer Anfrage bis zu 6 Offerten von geprüften Schweizer Umzugsfirmen. Das spart Zeit und ermöglicht einen direkten Vergleich – ohne mühsames Herumtelefonieren.
            </p>
            <p className="typography-p mb-4">
              ...
              <table className="min-w-full border-collapse border border-gray-300">
                <thead>
                  <tr className="bg-gray-100">
                    <th className="border border-gray-300 px-4 py-2 text-left typography-h4">Vorteil</th>
                    <th className="border border-gray-300 px-4 py-2 text-left typography-h4">Beschreibung</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="border border-gray-300 px-4 py-2 typography-p">Bessere Preise</td>
                    <td className="border border-gray-300 px-4 py-2 typography-p">Wettbewerb zwischen Anbietern führt zu fairen Konditionen</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 px-4 py-2 typography-p">Mehr Transparenz</td>
                    <td className="border border-gray-300 px-4 py-2 typography-p">Detaillierte Aufschlüsselung aller Leistungen und Kosten</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 px-4 py-2 typography-p">Passende Leistungen</td>
                    <td className="border border-gray-300 px-4 py-2 typography-p">Angebote, die genau auf Ihre Bedürfnisse zugeschnitten sind</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 px-4 py-2 typography-p">Höhere Planungssicherheit</td>
                    <td className="border border-gray-300 px-4 py-2 typography-p">Klare Angaben zu Terminen, Umfang und Budget</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <h2 id="was-ist-umzugsofferte" className="typography-h2 mb-4 mt-8 scroll-mt-24">
            ...
            <h3 id="verbindlichkeit" className="typography-h3 mb-4 mt-6 scroll-mt-24">
            ...
            <ul className="list-disc list-inside space-y-2 mb-6 typography-p">
            ...
            <h3 id="kosten-offerte" className="typography-h3 mb-4 mt-6 scroll-mt-24">
            ...
            <h2 id="transparente-offerte" className="typography-h2 mb-4 mt-8 scroll-mt-24">
            ...
            <h3 id="leistungen-umfang" className="typography-h3 mb-4 mt-6 scroll-mt-24">
            ...
            <h3 id="preise-zuschlaege" className="typography-h3 mb-4 mt-6 scroll-mt-24">
            ...
            <div className="overflow-x-auto mb-6">
              <table className="min-w-full border-collapse border border-gray-300">
                <thead>
                  <tr className="bg-gray-100">
                    <th className="border border-gray-300 px-4 py-2 text-left typography-h4">Preismodell</th>
                    <th className="border border-gray-300 px-4 py-2 text-left typography-h4">Vorteile</th>
                    <th className="border border-gray-300 px-4 py-2 text-left typography-h4">Nachteile</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="border border-gray-300 px-4 py-2 typography-p">Festpreis</td>
                    <td className="border border-gray-300 px-4 py-2 typography-p">Planungssicherheit, keine Überraschungen</td>
                    <td className="border border-gray-300 px-4 py-2 typography-p">Weniger flexibel bei Änderungen</td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 px-4 py-2 typography-p">Stundensatz</td>
                    <td className="border border-gray-300 px-4 py-2 typography-p">Zahlung nach Aufwand, flexibel</td>
                    <td className="border border-gray-300 px-4 py-2 typography-p">Risiko bei Verzögerungen</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <h3 id="termin-dauer" className="typography-h3 mb-4 mt-6 scroll-mt-24">
            ...
            <h3 id="versicherung-haftung" className="typography-h3 mb-4 mt-6 scroll-mt-24">
            ...
            <h3 id="bedingungen-zahlung" className="typography-h3 mb-4 mt-6 scroll-mt-24">
            ...
            <h2 id="vergleich-funktioniert" className="typography-h2 mb-4 mt-8 scroll-mt-24">
            ...
            <h3 id="schritt-1" className="typography-h3 mb-4 mt-6 scroll-mt-24">
            ...
            <h3 id="schritt-2" className="typography-h3 mb-4 mt-6 scroll-mt-24">
              Schritt 2: Bis zu 6 Offerten von geprüften Umzugsfirmen erhalten
            </h3>
            <p className="typography-p mb-4">
              Ihre Anfrage wird an passende, geprüfte Umzugsunternehmen in Ihrer Region weitergeleitet. In der Regel erhalten Sie innerhalb von 24 bis 48 Stunden bis zu 6 individuelle Offerten.
            </p>
            <p className="typography-p mb-4">
            ...
            <h3 id="schritt-3" className="typography-h3 mb-4 mt-6 scroll-mt-24">
            ...
            <div className="overflow-x-auto mb-6">
              <table className="min-w-full border-collapse border border-gray-300">
                <thead>
                  <tr className="bg-gray-100">
                    <th className="border border-gray-300 px-4 py-2 text-left typography-h4">Kriterium</th>
                    <th className="border border-gray-300 px-4 py-2 text-left typography-h4">Firma A</th>
                    <th className="border border-gray-300 px-4 py-2 text-left typography-h4">Firma B</th>
                    <th className="border border-gray-300 px-4 py-2 text-left typography-h4">Firma C</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="border border-gray-300 px-4 py-2 typography-p">Gesamtpreis</td>
                    <td className="border border-gray-300 px-4 py-2 typography-p"></td>
                    <td className="border border-gray-300 px-4 py-2 typography-p"></td>
                    <td className="border border-gray-300 px-4 py-2 typography-p"></td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 px-4 py-2 typography-p">Enthaltene Leistungen</td>
                    <td className="border border-gray-300 px-4 py-2 typography-p"></td>
                    <td className="border border-gray-300 px-4 py-2 typography-p"></td>
                    <td className="border border-gray-300 px-4 py-2 typography-p"></td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 px-4 py-2 typography-p">Versicherungsschutz</td>
                    <td className="border border-gray-300 px-4 py-2 typography-p"></td>
                    <td className="border border-gray-300 px-4 py-2 typography-p"></td>
                    <td className="border border-gray-300 px-4 py-2 typography-p"></td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 px-4 py-2 typography-p">Erfahrung / Bewertungen</td>
                    <td className="border border-gray-300 px-4 py-2 typography-p"></td>
                    <td className="border border-gray-300 px-4 py-2 typography-p"></td>
                    <td className="border border-gray-300 px-4 py-2 typography-p"></td>
                  </tr>
                  <tr>
                    <td className="border border-gray-300 px-4 py-2 typography-p">Erreichbarkeit</td>
                    <td className="border border-gray-300 px-4 py-2 typography-p"></td>
                    <td className="border border-gray-300 px-4 py-2 typography-p"></td>
                    <td className="border border-gray-300 px-4 py-2 typography-p"></td>
                  </tr>
            ...
            <h2 id="wann-einholen" className="typography-h2 mb-4 mt-8 scroll-mt-24">
            ...
            <h3 id="fruehzeitige-planung" className="typography-h3 mb-4 mt-6 scroll-mt-24">
            ...
            <h3 id="kurzfristiger-umzug" className="typography-h3 mb-4 mt-6 scroll-mt-24">
            ...
            <h2 id="tipps-auswahl" className="typography-h2 mb-4 mt-8 scroll-mt-24">
            ...
            <h3 id="leistungsumfang-preis" className="typography-h3 mb-4 mt-6 scroll-mt-24">
            ...
            <h3 id="erfahrungen-bewertungen" className="typography-h3 mb-4 mt-6 scroll-mt-24">
            ...
            <h3 id="details-klaeren" className="typography-h3 mb-4 mt-6 scroll-mt-24">
            ...
            <h2 id="fazit" className="typography-h2 mb-4 mt-8 scroll-mt-24">
            ...
            <p className="typography-p mb-4">
              Online-Offerten.ch vereinfacht diesen Prozess: Mit einer einzigen Anfrage erhalten Sie bis zu 6 Offerten von geprüften Schweizer Zügelunternehmen. So finden Sie schnell und unkompliziert die richtige Umzugsfirma – passend zu Ihrem Ort, Ihrer Art des Umzugs und Ihren individuellen Bedürfnissen.
            </p>
