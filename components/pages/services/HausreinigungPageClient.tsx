            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
              ...
              <div className="lg:col-span-2 w-full min-w-0">
                ...
                >
                  ...
                  <h2 className="typography-h2 mt-8 md:mt-12 mb-6 break-words">Was bei einer gründlichen Hausreinigung gereinigt wird</h2>
                  <p className="typography-p mb-6 break-words w-full">
                  ...
                  <h2 className="typography-h2 mt-8 md:mt-12 mb-6 break-words">Ablauf unserer Hausreinigung – Schritt für Schritt</h2>
                  <p className="typography-p mb-6 break-words w-full">
                  ...
                  <h2 className="typography-h2 mt-8 md:mt-12 mb-6">Was kostet eine professionelle Hausreinigung?</h2>
                  ...
                  <div className="mt-8 md:mt-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                      <Link href="/reinigung/umzugsreinigung" className="p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                        ...
                        <p className="typography-p text-sm">Professionelle Umzugsreinigung mit Abnahmegarantie für eine sorgenfreie Hausübergabe.</p>
                      </Link>
