  ...
  const faqItems = [
    {
      ...
      a: "Die Kosten für Hausreinigung mit Abnahmegarantie hängen von der Grösse des Hauses, dem Zustand und dem Umfang der Reinigung ab. Eine durchschnittliche 3-Zimmer-Haus kostet etwa 400-900 CHF. Die Abnahmegarantie ist in der Regel im Preis enthalten und gibt Ihnen die Sicherheit, dass das Haus den Anforderungen entspricht. Durch den Vergleich mehrerer Offerten können Sie bis zu 40% sparen."
    },
    {
      q: "Was bedeutet Abnahmegarantie bei der Hausreinigung?",
      a: "Die Abnahmegarantie bedeutet, dass die Reinigungsfirma garantiert, dass das Haus den Anforderungen für die Übergabe entspricht. Sollte der Käufer oder neue Eigentümer bei der Übergabe Mängel feststellen, wird die Reinigungsfirma kostenlos nachbessern, bis das Haus den Anforderungen entspricht. Dies gibt Ihnen maximale Sicherheit und spart Zeit und Nerven bei der Hausübergabe."
    },
    {
    ...
    },
    {
      ...
      a: "Die Dauer hängt von der Grösse des Hauses und dem Zustand ab. Eine durchschnittliche 3-Zimmer-Haus benötigt etwa 3-5 Stunden. Grössere Häuser oder stark verschmutzte Bereiche können länger dauern. Professionelle Reinigungsteams arbeiten effizient und systematisch, um optimale Ergebnisse in angemessener Zeit zu erzielen."
    },
    {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
              ...
              <div className="lg:col-span-2 w-full min-w-0">
                ...
                >
                  ...
                  <h2 className="heading-2 mt-8 md:mt-12 mb-6 break-words">Was bei einer gründlichen Hausreinigung gereinigt wird</h2>
                  <p className="text-body mb-6 break-words w-full">
                  ...
                  <h2 className="heading-2 mt-8 md:mt-12 mb-6 break-words">Ablauf unserer Hausreinigung – Schritt für Schritt</h2>
                  <p className="text-body mb-6 break-words w-full">
                  ...
                  <p className="text-body mb-6">
                    Die Kosten für Hausreinigung variieren je nach Grösse des Hauses, Umfang der Reinigung und Region. In der Regel werden Preise zwischen 25 und 50 CHF pro Stunde berechnet. Eine durchschnittliche 3-Zimmer-Haus benötigt etwa 3-4 Stunden, was Kosten von 75-200 CHF bedeutet. Grössere Häuser oder besonders verschmutzte Bereiche können höhere Kosten verursachen. Durch den Vergleich mehrerer Offerten über unsere Plattform können Sie bis zu 40% sparen und gleichzeitig sicherstellen, dass Sie qualitativ hochwertige Dienstleistungen mit Abnahmegarantie erhalten. Alle Offerten sind kostenlos und unverbindlich.
                  </p>
                  ...
                  <div className="mt-8 md:mt-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
                      <Link href="/reinigung/umzugsreinigung" className="p-4 bg-blue-50 rounded-lg hover:bg-blue-100 transition-colors">
                        ...
                        <p className="text-body text-sm">Professionelle Umzugsreinigung mit Abnahmegarantie für eine sorgenfreie Hausübergabe.</p>
                      </Link>
