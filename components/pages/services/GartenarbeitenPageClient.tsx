...
const GartenarbeitenPageClient = () => {
          ...
          <div className="container mx-auto max-w-7xl px-4 md:px-6">
            <div className="grid lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2">
                ...
                >
                  <h2 className="heading-2">Gartenarbeiten in der Schweiz: Professionelle Dienstleistungen für Ihren Traumgarten</h2>
                  ...
                  <h3 className="heading-3">Was sind Gartenarbeiten?</h3>
                  <p className="text-body mb-6 leading-relaxed">
                  ...
                  <h3 className="heading-3">Gartenpflege: Die Basis für einen gesunden Garten</h3>
                  <p className="text-body mb-6 leading-relaxed">
                  ...
                  <h3 className="heading-3">Landschaftsbau: Gestalten Sie Ihren Traumgarten</h3>
                  <p className="text-body mb-6 leading-relaxed">
                  ...
                  <h3 className="heading-3">Terrassenverlegung: Mehr Wohnraum im Freien</h3>
                  <p className="text-body mb-6 leading-relaxed">
                  ...
                  <h3 className="heading-3">Pool-Service: Rundum-Sorglos-Paket für Ihren Pool</h3>
                  <p className="text-body mb-6 leading-relaxed">
                  ...
                  <h3 className="heading-3">Gartenhausbau: Funktionalität und Ästhetik vereint</h3>
                  <p className="text-body mb-6 leading-relaxed">
                  ...
                  <h3 className="heading-3">Saunabau: Wellness im eigenen Garten</h3>
                  <p className="text-body mb-6 leading-relaxed">
                  ...
                  <h3 className="heading-3">Sporteinrichtungsbau: Aktivität im Freien</h3>
                  <p className="text-body mb-6 leading-relaxed">
                  ...
                  <h3 className="heading-3">Warum professionelle Gartenarbeiten wichtig sind</h3>
                  <p className="text-body mb-6 leading-relaxed">
                  ...
                  <h3 className="heading-3">Kosten für Gartenarbeiten in der Schweiz</h3>
                  <p className="text-body mb-6 leading-relaxed">
                  ...
                  <h3 className="heading-3">So finden Sie die richtige Gärtnerei</h3>
                  <p className="text-body mb-6 leading-relaxed">
                  ...
                  <div className="mt-10 p-6 bg-green-50 rounded-lg border border-green-200">
                    <h3 className="heading-3">Jetzt kostenlose Offerten anfordern</h3>
              ...
              <div className="lg:col-span-1">
                ...
                >
                  <div className="bg-white rounded-xl shadow-lg p-6">
                    <h3 className="heading-3">Vorteile</h3>
...
export default GartenarbeitenPageClient
