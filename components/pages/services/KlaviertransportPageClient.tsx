...
const KlaviertransportSidebar = ({ quoteUrl }: { quoteUrl: string }) => {
  const klaviertransportQuoteUrl = `${quoteUrl}?service=umzug&step=2&umzugArt=spezialtransport&special_transport_type=klaviertransport`
      ...
      <Card className="bg-gradient-to-br from-green-50 to-emerald-50 border-green-200 shadow-lg">
        ...
        <CardContent className="space-y-4">
          ...
          <Button asChild className="w-full bg-green-600 hover:bg-green-700">
            <Link href={klaviertransportQuoteUrl} rel="noopener noreferrer">
...
const KlaviertransportPageClient = () => {
  ...
  const servicesData = {
    ...
    subtitle: "",
    paragraphs: [
      "Ein Klaviertransport ist weit mehr als nur das Bewegen eines schweren Gegenstands – er erfordert spezialisierte Dienstleistungen, die auf die besonderen Anforderungen von Klavieren, Flügeln und Pianos zugeschnitten sind. Eine erfahrene Klaviertransportfirma wie Meister-Klaviertransport bietet individuelle Lösungen, die exakt auf Ihr Instrument und den gewünschten Zielort abgestimmt sind. Von der ersten Kontaktaufnahme bis zur sicheren Ankunft am Bestimmungsort profitieren Sie von einer professionellen Planung, die alle Details des Transports berücksichtigt.",
        ...
        <div className="container mx-auto max-w-navbar px-4 md:px-6">
          <div className="grid lg:grid-cols-12 gap-8">
            ...
            <aside className="lg:col-span-4 mt-12 lg:mt-0">
              <KlaviertransportSidebar quoteUrl={quoteUrl} />
            </aside>
          </div>
        </div>
