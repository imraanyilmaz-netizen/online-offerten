    ...
    <>
      <div className="bg-white">
        ...
        <div className="container mx-auto max-w-7xl px-4 md:px-6 py-12 md:py-16">
          ...
          >
            <div className="mb-8">
              <h2 id="einfuehrung-umzugskosten" className="typography-h2 mb-6 scroll-mt-24">Einführung in die Umzugskosten</h2>
            ...
            <div className="mb-8">
              <h2 id="durchschnittliche-umzugskosten" className="typography-h2 mb-6 scroll-mt-24">Durchschnittliche Umzugskosten in der Schweiz</h2>
              <div className="space-y-4">
                <p className="typography-p">
            ...
            <div className="mb-8">
              <h2 id="umzugspreis-kalkulation" className="typography-h2 mb-6 scroll-mt-24">Schnelle und präzise Umzugspreis-Kalkulation</h2>
              <p className="typography-p">
            ...
            <div>
              <h2 id="guenstig-umziehen-tipps" className="typography-h2 mb-6 scroll-mt-24">Günstig umziehen in der Schweiz: Tipps zum Sparen</h2>
              <p className="typography-p mb-6">
          ...
          <motion.section 
            ...
            className="bg-white"
          >
            <h2 id="faktoren-beeinflussen" className="typography-h2 mb-6 text-center scroll-mt-24">
            ...
            <p className="typography-p text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <motion.div 
              ...
              className="bg-white"
            >
              <h3 className="typography-h3 mb-4">Stundensätze von Umzugsfirmen</h3>
          ...
          >
            <div className="flex items-center mb-4">
              ...
              <h2 id="umzug-angebot-vergleichen" className="typography-h2 scroll-mt-24">Umzug Angebot vergleichen: Geprüfte Partner</h2>
            </div>
            <p className="typography-p">
          ...
          <motion.section 
            ...
            className="bg-white"
          >
            <h2 id="regionale-preisunterschiede" className="typography-h2 mb-6 text-center scroll-mt-24">
          ...
          <motion.section 
            ...
            className="bg-white"
            >
            <h2 id="diy-oder-professionell" className="typography-h2 mb-6 scroll-mt-24">DIY-Umzug oder professionelle Umzugsfirma: Was passt zu Ihnen?</h2>
            <div className="space-y-4">
              <p className="typography-p">
          ...
          <motion.section 
            ...
            className="bg-white"
          >
            <h2 id="kosten-nach-zimmeranzahl" className="typography-h2 mb-4 scroll-mt-24">Umzugsfirma Kosten: Preise nach Zimmeranzahl</h2>
            <p className="typography-p mb-4">
          ...
          <motion.section 
            ...
            className="bg-white"
          >
            <h2 id="wie-berechnet" className="typography-h2 mb-4 scroll-mt-24">Wie werden die Umzugskosten berechnet?</h2>
            <p className="typography-p mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div className="bg-emerald-50 p-4 rounded-lg border-l-4 border-emerald-500">
                <h3 className="typography-h3 mb-2">Datenbasis</h3>
                <p className="typography-p text-sm">Aktuelle Preise von über 500 geprüften Umzugsfirmen in der Schweiz, aktualisiert monatlich.</p>
              </div>
              <div className="bg-emerald-50 p-4 rounded-lg border-l-4 border-emerald-500">
                <h3 className="typography-h3 mb-2">Berechnungsfaktoren</h3>
                <p className="typography-p text-sm">Wohnungsgrösse (Zimmeranzahl), Distanz (km), Zusatzleistungen (Reinigung, Möbelmontage). Die <strong>Kosten für einen Umzug</strong> werden durch <strong>verschiedene Faktoren</strong> beeinflusst. Ein <strong>Umzug mit einer Umzugsfirma</strong> kann <strong>pro Stunde</strong> berechnet werden oder basierend auf dem Umfang.</p>
              </div>
              <div className="bg-emerald-50 p-4 rounded-lg border-l-4 border-emerald-500">
                <h3 className="typography-h3 mb-2">Preisstruktur</h3>
                <p className="typography-p text-sm">Basispreise: CHF 600-2'250 je nach Zimmeranzahl. Distanzkosten: CHF 2 pro km. Zusatzleistungen: CHF 400-500.</p>
              </div>
              <div className="bg-emerald-50 p-4 rounded-lg border-l-4 border-emerald-500">
                <h3 className="typography-h3 mb-2">Aktualität</h3>
                <p className="typography-p text-sm">Preisdaten werden monatlich aktualisiert, um aktuelle Marktpreise widerzuspiegeln.</p>
              </div>
            </div>
            <p className="typography-p">
          ...
          <motion.section 
            ...
            className="bg-white"
          >
            <h2 id="preis-pro-km" className="typography-h2 mb-4 scroll-mt-24">Umzug Preis pro km und versteckte Kosten</h2>
            <p className="typography-p mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div className="bg-white p-4 rounded-lg shadow">
                <h3 className="typography-h3 mb-2">Parkgebühren & Parkverbote</h3>
                <p className="typography-p text-sm">Für Umzugswagen benötigen Sie oft Parkverbotsschilder, die CHF 50-150 kosten können.</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow">
                <h3 className="typography-h3 mb-2">Aufzuggebühren</h3>
                <p className="typography-p text-sm">In Hochhäusern können Aufzuggebühren CHF 100-300 betragen, besonders bei sperrigen Möbeln.</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow">
                <h3 className="typography-h3 mb-2">Verpackungsmaterial</h3>
                <p className="typography-p text-sm">Kartons, Folie und Verpackungsmaterial können CHF 200-500 zusätzlich kosten.</p>
              </div>
              <div className="bg-white p-4 rounded-lg shadow">
                <h3 className="typography-h3 mb-2">Umzugsversicherung</h3>
                <p className="typography-p text-sm">Eine Transportversicherung für wertvolle Möbel kostet CHF 100-300, ist aber empfehlenswert.</p>
              </div>
            </div>
            <p className="typography-p">
          ...
          <motion.section 
            ...
            className="bg-white"
          >
            <h2 id="ablauf-tipps" className="typography-h2 mb-6 scroll-mt-24">Beim Umzug: Ablauf und praktische Tipps</h2>
            <p className="typography-p">
          ...
          >
            <h2 id="haeufige-fragen" className="typography-h2 mb-6 text-center scroll-mt-24">Häufige Fragen zu Umzugskosten und Preisen</h2>
              ...
              {faqItems.map((item, index) => (
                ...
                >
                  <AccordionTrigger className="text-left hover:no-underline py-4 px-5 transition-colors">
                    <span className="typography-span flex-1 pr-4">{item.question}</span>
                  </AccordionTrigger>
                  <AccordionContent className="pt-0 pb-5 px-5 border-t border-gray-100">
                    <p className="typography-p whitespace-pre-wrap">{item.answer}</p>
                  </AccordionContent>
                </AccordionItem>
              ))}
            </Accordion>
          ...
          <motion.section 
            ...
            className="bg-white"
          >
            <h2 id="fazit" className="typography-h2 mb-6 scroll-mt-24">Fazit</h2>
            <p className="typography-p">
