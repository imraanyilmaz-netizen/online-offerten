...
const BernSidebar = () => {
  ...
  const services = [
    { 
      ...
      url: '/kostenlose-offerte-anfordern?service=umzug&step=2&umzugArt=privatumzug&city=Bern'
    },
    { 
      id: 'geschaeftsumzug',
      name: 'Geschäftsumzug',
      ...
      url: '/kostenlose-offerte-anfordern?service=umzug&step=3&umzugArt=geschaeftsumzug&city=Bern'
    },
    { 
      id: 'international',
      ...
      url: '/kostenlose-offerte-anfordern?service=umzug&step=3&umzugArt=international&city=Bern'
    },
    { 
      id: 'spezialtransport',
      ...
      url: '/kostenlose-offerte-anfordern?service=umzug&step=3&umzugArt=spezialtransport&special_transport_type=klaviertransport&city=Bern'
    },
    { 
      id: 'kleintransport',
      name: 'Kleintransport',
